...
import com.android.sprdlauncher2.AppWidgetResizeFrame;
import com.android.sprdlauncher2.DragLayer;
import com.android.sprdlauncher2.ItemInfo;
import com.android.sprdlauncher2.LauncherAppWidgetHostView;
...
import com.android.sprdlauncher2.ShortcutAndWidgetContainer;
import com.android.sprdlauncher2.LauncherSettings;
import com.android.sprdlauncher2.FolderIcon.FolderRingAnimator;
import com.android.sprdlauncher2.Launcher.CustomContentCallbacks;
import com.android.sprdlauncher2.LauncherSettings.Favorites;
...
public abstract class Workspace extends SmoothPagedView
    ...
    protected final static long EXTRA_EMPTY_SCREEN_ID = -201;
    protected final static long CUSTOM_CONTENT_SCREEN_ID = -301;

    protected HashMap<Long, CellLayout> mWorkspaceScreens = new HashMap<Long, CellLayout>();
    protected ArrayList<Long> mScreenOrder = new ArrayList<Long>();
    ...
    /* SPRD: add for UUI previews @{*/
    protected float mMultiTouchStart;
    protected float mMultiTouchStop;
    /* @} */

    // SPRD: Fix bug 292421, Icon will be gone after interrupt icon's drag status.
    public boolean mIsUnistalling;
    ...
    public void onDragStart(final DragSource source, Object info, int dragAction) {
        ...
        /* SPRD: Feature 255104,crash when drag widget or icon @{
          post(new
          Runnable() {
          @Override public void run() { if (mIsDragOccuring) {
...
//            AlphaUpdateListener.updateVisibility(searchBar);// SPRD: fix bug 263762,hide search bar
    ...
    void startDrag(CellLayout.CellInfo cellInfo) {
        ...
        /* SPRD: fix bug 265420 cell parent maybe is null @{
        if (!child.isInTouchMode()) {
            return;
        }
        */
        ViewParent parent = child.getParent();
        if (!child.isInTouchMode() || parent == null) {
            return;
        }
        /* @} */
    ...
    public boolean acceptDrop(DragObject d) {
        ...
        if (d.dragSource != this) {
            ...
            /* SPRD: Fix bug260915,we don't allow an item drop on left/right ADD_SCREEN. @{ */
            if (dropTargetLayout.mEditAdd) {
                return false;
            }
            /* @} */
            ...
            /* SPRD: Fix bug 285036,do not allow the item add to Exist Folder
             * which is drag from AppsCustomizePagedView. @{ */
            // SPRD: fix bug275403
            if (willAddToExistingUserFolder((ItemInfo) d.dragInfo, dropTargetLayout,
                    mTargetCell, distance, d.dragSource)) {
                return true;
            }
            /* @} */
    ...
    boolean willAddToExistingUserFolder(Object dragInfo, CellLayout target, int[] targetCell,
            float distance, DragSource source) {
        if ((source != null) && (source instanceof AppsCustomizePagedView)) return false;
        if (distance > mMaxDistanceForFolderCreation) return false;
        View dropOverView = target.getChildAt(targetCell[0], targetCell[1]);
        ...
        if (d.dragSource != this) {
            ...
            if (dropTargetLayout != null && !d.cancelled) {
                ...
                if (foundCell) {
                    ...
                    if (hasMovedLayouts) {
                        // Reparent the view
                        /* SPRD: fix bug325793, cell's parent may be null. @{ */
                        CellLayout oldCellLayout = getParentCellLayoutForView(cell);
                        if (oldCellLayout != null) {
                            oldCellLayout.removeView(cell);
                        } else {
                            Log.w(TAG, "onDrop() : reparent the view, the cell's parent is null, " + ((ItemInfo)cell.getTag()).toString());
                        }
                        /* @} */
            ...
            if (cell.getParent() != null) {
                ...
                */
                ...
                if (info.itemType == LauncherSettings.Favorites.ITEM_TYPE_APPWIDGET) {
                    ...
                    animateWidgetDrop(info, parent, d.dragView, onCompleteRunnable,
                            animationType, cell, false);
                } else {
                    int duration = snapScreen < 0 ? -1
                            : ADJACENT_SCREEN_DROP_DURATION;
                    mLauncher.getDragLayer().animateViewIntoPosition(d.dragView,
                            cell, duration, onCompleteRunnable, this);
                    /* SPRD: Fix bug 298303 @{*/
                    CellLayout layout = (CellLayout) cell.getParent().getParent();
                    layout.markCellsAsOccupiedForView(cell);
                    /* @} */
                ...
                */
                ...
                Log.w(TAG, "onDrop() : add animate, the cell's parent is null, " + ((ItemInfo)cell.getTag()).toString());
            }
            /* @} */
        }
    }
    ...
    public void onDragExit(DragObject d) {
     ...
     // SPRD: fix 271376
        if (!mIsPageMoving && !mLauncher.isEditingMode()) {
            hideOutlines();
        }
    }
   ...
   static private float squaredDistance(float[] point1, float[] point2) {
    ...
    public void onDragOver(DragObject d) {
        ...
        /* SPRD: Fix bug260915,we don't allow an item drop on left/right ADD_SCREEN. @{ */
        if (mDragTargetLayout != null && mDragTargetLayout.mEditAdd) return;
        /* @} */
        ...
        if (isSmall()) {
            ...
            /* SPRD: fix bug260972 @{ */
            if(mLauncher.isHotseatLayout(layout) && mLauncher.isEditingMode()){
                setCurrentDropLayout(null);
                setCurrentDragOverlappingLayout(null);
            }
            /* @} */
        ...
        if (mDragTargetLayout != null) {
            ...
            manageFolderFeedback(info, mDragTargetLayout, mTargetCell,
                    targetCellDistance, dragOverView, d.dragSource);
            /* @} */
    ...
    private void manageFolderFeedback(ItemInfo info, CellLayout targetLayout,
            int[] targetCell, float distance, View dragOverView, DragSource source) {
        ...
        boolean willAddToFolder =
                willAddToExistingUserFolder(info, targetLayout, targetCell, distance, source);
        ...
        if (info instanceof PendingAddItemInfo) {
            ...
            if (pendingInfo.itemType == LauncherSettings.Favorites.ITEM_TYPE_SHORTCUT) {
                ...
                if (willCreateUserFolder((ItemInfo) d.dragInfo, cellLayout, mTargetCell,
                        distance, true) || willAddToExistingUserFolder((ItemInfo) d.dragInfo,
                                cellLayout, mTargetCell, distance, d.dragSource)) {
            ...
            Runnable onAnimationCompleteRunnable = new Runnable() {
                ...
                public void run() {
                    ...
                    /* SPRD: Feature 261947,Add custome widget into workspace. @{ */
                    ...
                    case LauncherSettings.Favorites.ITEM_TYPE_EMPTY_FOLDER:
                        mLauncher.processEmptyFolderFromDrop(cellLayout, container, screenId, mTargetCell, null);
                        break;
                        /* @} */
                    default:
            ...
            case LauncherSettings.Favorites.ITEM_TYPE_SHORTCUT:
                if (info.container == NO_ID && info instanceof AppInfo) {
                    ...
                    info = new SprdShortcutInfo((AppInfo) info);
                }
    ...
    public void onDropCompleted(final View target, final DragObject d,
        ...
        if ((d.cancelled || (beingCalledAfterUninstall && !mUninstallSuccessful))
            ...
            mIsUnistalling = false;
            /* @} */

            /* SPRD: Fix bug297228、bug327056 @{ */
    ...
    public boolean onEnterScrollArea(int x, int y, int direction) {
        ...
        if (!isSmall() && !mIsSwitchingState && getOpenFolder() == null) {
            ...
            if (0 <= page && page < getChildCount()) {
                ...
                /* SPRD: add for @{ */
                if (mLauncher.isEditingMode() && layout.mEditAdd) {
                    return false;
                }
                /* @} */
                setCurrentDragOverlappingLayout(layout);
    ...
    protected abstract float spacing(MotionEvent event);
}
