...
public class GlobalSearchSupport {
    ...
    private Cursor addSearchSuggestionsBasedOnFilter(MatrixCursor cursor, SQLiteDatabase db,
        ...
        String contactsView = mContactsProvider.getDatabaseHelper(context)
                .getContactsView(ContactsDatabaseHelper.canAccessRestrictedData(context));
        ...
        try {
            while (c.moveToNext()) {
                ...
                if (haveFilter) {
                    ...
                    /**
                     * SPRD bug524638 during searching contacts, there are two search history,
                     * after doing lock and unlock device, there is only piece of history
                     */
