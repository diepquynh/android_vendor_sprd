...
LOCAL unsigned long _ov2680_PowerOn(unsigned long power_on)
{
	...
	SENSOR_PRINT("SENSOR_ov2680: _ov2680_Power_On(1:on, 0:off): %ld", power_on);
...
LOCAL unsigned long _ov2680_write_exposure_dummy(uint16_t expsure_line,uint16_t dummy_line,uint16_t size_index)
{
...
LOCAL unsigned long _ov2680_write_exposure(unsigned long param)
{
	...
	size_index=(param>>0x1c)&0x0f;
	 ...
	 _ov2680_write_exposure_dummy(expsure_line,dummy_line,size_index);
...
LOCAL unsigned long _ov2680_ex_write_exposure(unsigned long param)
{
	...
	_ov2680_write_exposure_dummy(exposure_line,dummy_line,size_index);
...
#define DW9714_VCM_SLAVE_ADDR (0x18>>1)
	...
	SENSOR_PRINT("SENSOR_ov2680: _write_af %ld", param);
...
LOCAL unsigned long _ov2680_BeforeSnapshot(unsigned long param)
{
	...
	SENSOR_PRINT("%d,%ld.",cap_mode,param);
