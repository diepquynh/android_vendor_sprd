...
public abstract class AbstractActivityController implements ActivityController,
    ...
    /* @} */
    private final String  IS_JUMPED_TO_ACCOUNTSETUPFINAL= "IsJumpedToAccountSetup"; /* SPRD: Modify for  bug611753   */
    /**
    ...
    boolean mJumpToAccountSetup = false;/* SPRD: Modify for bug611753 */
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        switch (requestCode) {
            case ADD_ACCOUNT_REQUEST_CODE:
                mJumpToAccountSetup = false; /* SPRD: Modify for  bug611753  */
    ...
    public void onCreate(Bundle savedState) {
        ...
        if (savedState != null) {
            ...
            mJumpToAccountSetup = savedState.getBoolean(IS_JUMPED_TO_ACCOUNTSETUPFINAL);/* SPRD: Modify for  bug611753  */
            mDialogFromSelectedSet = savedState.getBoolean(SAVED_ACTION_FROM_SELECTED, false);
            mViewMode.handleRestore(savedState);
            /* SPRD: Modify for bug631088  {@ */
    ...
    public void starMessage(ConversationMessage msg, boolean starred) {
        ...
        Conversation con = mCheckedSet != null ? mCheckedSet.getConversation(conv.id) : null;
        if (con != null) {
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putBoolean(IS_JUMPED_TO_ACCOUNTSETUPFINAL, mJumpToAccountSetup); /* SPRD: Modify for  bug611753   */
    ...
    public void startSearch() {
        ...
        if (mAccount.supportsSearch()) {
            /* SPRD: Modify for bug581956 {@ */
            exitCabMode();
            /* @} */
            /* SPRD: Modify for bug 626502 {@ */
            if (mViewMode.getMode() != ViewMode.CONVERSATION){
                mSearchViewController.showSearchActionBar(
                        MaterialSearchViewController.SEARCH_VIEW_STATE_VISIBLE);
            }
                        ...
                        if (accountsLoaded) {
                            ...
                            if (noAccountIntent != null) {
                                mActivity.startActivityForResult(noAccountIntent,
                                        ...
                                        mJumpToAccountSetup = true; /* SPRD: Modify for  bug611753  */
                            }
                        }
                    } else {
