...
#ifndef SENSORCOORDINATE_H_
#define SENSORCOORDINATE_H_
...
class SensorCoordinate {
  ...
  */
  enum sensors_placement_t {
    // !< Sensor on the same side of screen, x-axis point forward
    OBVERSE_X_AXIS_FORWARD,
    // !< Sensor on the same side of screen, x-axis point rightward
    OBVERSE_X_AXIS_RIGHTWARD,
    // !< Sensor on the same side of screen, x-axis point backward
    OBVERSE_X_AXIS_BACKWARD,
    // !< Sensor on the same side of screen, x-axis point leftward
