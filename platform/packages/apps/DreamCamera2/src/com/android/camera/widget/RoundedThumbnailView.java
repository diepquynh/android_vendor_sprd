 ...
 */
public class RoundedThumbnailView extends View implements
    ...
    public RoundedThumbnailView(Context context, AttributeSet attrs) {
        ...
        if (context != null && context instanceof CameraActivity)
            ((CameraActivity) getContext()).getOrientationManager().addOnOrientationChangeListener(
                    this);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.rotate((float) -mOrientation);
        canvas.translate(-centerX, -centerY);
