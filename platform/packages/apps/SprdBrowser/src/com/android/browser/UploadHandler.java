...
public class UploadHandler {
    ...
    private static String LOGTAG = "UploadHandler";
    ...
    void openFileChooser(ValueCallback<Uri[]> callback, FileChooserParams fileChooserParams) {
        ...
        if (fileChooserParams.isCaptureEnabled() && captureIntents.length == 1) {
            ...
            /* SPRD: Modify for bug579563 {@ */
            Intent i = fileChooserParams.createIntent();
            String mType = i.getType();
            if(mType != null)
            {
                String mimeType = mType.split(",")[0];
                if(mimeType.equals(".jpeg") || mimeType.equals(".jpg") || mimeType.equals(".png") || mimeType.equals(".gif")){
                    i.setType("image/*");
                }
            }
