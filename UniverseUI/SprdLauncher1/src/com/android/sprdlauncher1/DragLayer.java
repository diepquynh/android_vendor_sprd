...
public class DragLayer extends FrameLayout implements ViewGroup.OnHierarchyChangeListener {
    ...
    public void addResizeFrame(ItemInfo itemInfo, LauncherAppWidgetHostView widget,
        ...
        /* SPRD: bug282114 2014-02-21 delay to add resize frame animation turned off @{ */
        final AppWidgetResizeFrame finalResizeFrame = resizeFrame;
        if (ValueAnimator.getDurationScale() == 0) {
            // if animation turn off by setting scale to 0 in develop settings
            // snapToWidget won't get the newest position of the drag-drop widget
            // because animation finished too fast, widget haven't update its position.
            // so in snapToWidget will get the original postion of widget and the
            // resize frame will not follow the widget and keep in the original position.
