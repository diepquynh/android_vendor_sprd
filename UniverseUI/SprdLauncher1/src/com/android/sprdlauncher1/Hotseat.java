...
public class Hotseat extends FrameLayout {
    ...
    /* SPRD: Feature 252093, Add a backHomeButton in hotseat. @{ */
    public TextView backHomeButton;
    public TextView allAppsButton;
    /* @} */
    ...
    void resetLayout() {
        ...
        if (!AppsCustomizePagedView.DISABLE_ALL_APPS) {
            ...
            //Add the BackHome button
            backHomeButton =(TextView)inflater.inflate(R.layout.application, mContent, false);
            Drawable homeButtonDrawable = context.getResources().getDrawable(R.drawable.home_button_icon);
            Utilities.resizeIconDrawable(homeButtonDrawable);
            backHomeButton.setCompoundDrawables(null, homeButtonDrawable, null, null);

            backHomeButton.setText(context.getString(R.string.all_apps_home_button_label));
            backHomeButton.setContentDescription(context.getString(R.string.all_apps_home_button_label));

            /* SPRD: Fix bug257857,bug297756,bug299345 @{
            ...
            */
            ...
            backHomeButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(android.view.View v) {
                    if (mLauncher != null) {
                        mLauncher.onClickHomeAppsButton(v);
                    }
                }
            });
            ...
            mContent.addViewToCellLayout(backHomeButton, -1, 0, lp, true);
            /* @} */
        }
    }

    /** SPRD: Feature 252093, Hotseat could accept clicks while workspace is in small state now. @{
    @Override
