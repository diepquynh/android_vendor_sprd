...
public class PageIndicatorMarker extends FrameLayout {
    ...
    void activate(boolean immediate) {
        /* SPRD: Fix bug298132, did not use animation to active the pageindicatormarker. @{ */
        immediate = true;
        if (immediate) {
//            mActiveMarker.animate().cancel();
    ...
    void inactivate(boolean immediate) {
        /* SPRD: Fix bug298132, did not use animation to inactive the pageindicatormarker. @{ */
        immediate = true;
        if (immediate) {
//            mInactiveMarker.animate().cancel();
