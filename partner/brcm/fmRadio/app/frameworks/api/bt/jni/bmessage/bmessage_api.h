...
#include "bmessage/bmessage_def.h"        /* For tBTA_MA_MSG_TYPE */
#include <stdio.h>
...
**
*******************************************************************************/
BTA_API extern void                        BTA_MaBmsgSetFolder(tBTA_MA_BMSG * p_msg, const char * p_folder);
/*******************************************************************************
**
...
**
*******************************************************************************/
BTA_API extern void                        BTA_MaBmsgAddMsgContent(tBTA_MA_BMSG_CONTENT * p_content, const char * p_text);
/*******************************************************************************
**
...
**
*******************************************************************************/
BTA_API extern tBTA_MA_VCARD_PROPERTY *    BTA_MaBmsgAddVcardProp(tBTA_MA_BMSG_VCARD * p_vcard, tBTA_MA_VCARD_PROP prop, const char * p_value, const char * p_param);
/*******************************************************************************
**
** Function         BTA_MaBmsgGetVcardProp
**
