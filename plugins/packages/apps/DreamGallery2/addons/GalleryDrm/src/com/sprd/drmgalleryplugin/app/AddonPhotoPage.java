...
public class AddonPhotoPage extends PhotoPageUtils implements
    ...
    private static final int MSG_CONSUME_DRM_RIGHTS = 18;
    ...
    public boolean cosumeDrmRights(Message message) {
        if (MSG_CONSUME_DRM_RIGHTS == message.what) {
            ...
            while ((drmImage = mQueueDrmWaitingConsumed.poll()) != null) {
                ...
                // SPRD: bug ,624616 ,Slide to DRM image, should Consume authority
                Toast.makeText(mAddonContext, mAddonContext.getString(R.string.drm_consumed),
                        Toast.LENGTH_SHORT).show();

                /* SPRD: bug 458241,624616 ,Slide to DRM image, should Consume authority @{
    ...
    public void setDrmPlayStatus(String filePath, int playbackStatus) {
        ...
        DrmManagerClientEx mDrmManagerClient = DrmUtil.getDrmManagerClient();
