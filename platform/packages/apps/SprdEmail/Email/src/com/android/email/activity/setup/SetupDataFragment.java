...
public class SetupDataFragment extends Fragment implements Parcelable {
    ...
    /* SPRD:bug499554, 573188 add begin @{ */
    public void setEmailAddress(String emailAddress) {
        ...
        if (emailAddress.contains("@") && !emailAddress.contains("/")) {
            ...
            String[] addrArray = emailAddress.split("/");
            int length = addrArray.length;
            if (length > 0) {
                mAccount.mEmailAddress = addrArray[length - 1];
                mEmail = mAccount.mEmailAddress;
            }
        }
    }
    /* @} */
    ...
    public EmailServiceUtils.EmailServiceInfo getIncomingServiceInfo(Context context) {
        ...
        if (mIncomingServiceInfo == null || EmailServiceUtils.isLocaleChanges(context)) {
        /* @} */
