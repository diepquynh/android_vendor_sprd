...
final public class RawContact implements Parcelable {
    ...
    /**
     * SPRD bug505144, 529590, 529791 add a default contact in list view
     * @{
     */
    public boolean isReadOnly() {
        final ContentValues values = getValues();
        if (values != null && values.getAsLong("is_read_only") != null) {
            int equals = values.getAsLong("is_read_only").compareTo(1L);
            return equals == 0;
        }
        return false;
    }
