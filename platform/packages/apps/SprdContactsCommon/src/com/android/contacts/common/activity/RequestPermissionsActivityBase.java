...
public abstract class RequestPermissionsActivityBase extends Activity
    ...
    public void onRequestPermissionsResult(int requestCode, String permissions[],
        ...
        if (permissions != null && permissions.length > 0
            ...
            /**
             * SPRD: 557539 Just display SIM Contacts，shut down all permissions of Contacts,Sim
             * Contacts display nothing when it goes into Contacts possibly
             * @{
             */
            if (!isFinishing()) {
                for (String perm : permissions) {
                    if (perm != null  && (permission.READ_CONTACTS.equals(perm) || permission.READ_PHONE_STATE.equals(perm))) {
            ...
            /**
             * SPRD: 600931 The DUT occurs crash after denying permission in the lock task mode.
             * android original:
            finish();
             * @{
             */
            ActivityManager activityManager = (ActivityManager) getSystemService(ACTIVITY_SERVICE);
            boolean lockTask = activityManager.isInLockTaskMode();
            Log.d(TAG, "RequestPermissionsActivityBase onRequestPermissionsResult lockTask : " + lockTask);
            if (!lockTask) {
                finish();
            }
            /*
