/**
 * connectivity_rf_parameters.h --- header for ini parser
 *
 * Copyright (C) 2015 Spreadtrum Communications Inc.
 */

#ifndef CONNECTIVITY_RF_PARAMETERS_H_
#define CONNECTIVITY_RF_PARAMETERS_H_
#include <stddef.h>
...
typedef struct { char public_reserved[10]; } public_config_t;
...
/*
API:
Get connectivity RF parameters including configure parameters
...
#define WIFI_CONFIG_TABLE(NAME, MEM_OFFSET, TYPE) \
  { NAME, (unsigned long)(offsetof(wifi_config_t, MEM_OFFSET)), TYPE }

#define WIFI_CALI_TABLE(NAME, MEM_OFFSET, TYPE) \
  { NAME, (unsigned long)(offsetof(wifi_cali_t, MEM_OFFSET)), TYPE }

#endif  // CONNECTIVITY_RF_PARAMETERS_H_
