...
public class EmailServiceProxy extends ServiceProxy implements IEmailService {
    ...
    /* SPRD: bug523600 add OOF function,Request the service to get oof settings for specified account {@ */
    ...
    /* SPRD: bug523600 add OOF function,Request to stop the service which is doing oof setting {@ */
