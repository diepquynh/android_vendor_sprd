...
import com.sprd.launcher3.widget.contacts.ContactAddLayout;
...
public class ShortcutAndWidgetContainer extends ViewGroup {
    ...
    public void measureChild(View child) {
        ...
        if (!lp.isFullscreen) {
            ...
            /* SPRD: Feature 254784,Launcher private widget should also skip set padding. @{
            if (child instanceof LauncherAppWidgetHostView) {
            */
            if (child instanceof LauncherAppWidgetHostView
                    || child instanceof ContactAddLayout) {
    ...
    public void cancelLongPress() {
        /* SPRD: Fix bug298132,Launcher slide optimize,there is no need to do cancelLongPress for all views. @{ */
        if (isPressed()) {
        ...
        for (int i = 0; i < count; i++) {
            final View child = getChildAt(i);
            /* SPRD: Fix bug 300183 @{ */
            if (child instanceof LauncherAppWidgetHostView || child.isPressed()) {
    ...
    public void invalidatePagedViewIcon() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (v instanceof PagedViewIcon) {
                ((PagedViewIcon) v).invalidatePagedViewIcon();
            }
        }
    }
    /* @} */
