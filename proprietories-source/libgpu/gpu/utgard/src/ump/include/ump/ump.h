...
UMP_API_EXPORT ump_handle ump_handle_create_from_phys_block(unsigned long phys_addr, unsigned long phys_size);

UMP_API_EXPORT void ump_free_handle_from_mapped_phys_block(ump_handle handle);
