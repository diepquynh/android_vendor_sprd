...
void *ae_sprd_init(struct ae_init_in *in_param, void *out_param);
int32_t ae_sprd_deinit(void *handler, void *in_param, void *out_param);
int32_t ae_sprd_calculation(void *handler, struct ae_calc_in *in_param, struct ae_calc_out *out_param);
