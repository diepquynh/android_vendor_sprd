...
public final class ContentType {
	...
	public static boolean isTextType(final String contentType) {
		return TEXT_PLAIN.equals(contentType) || TEXT_HTML.equals(contentType)
	...
	public static boolean isMediaType(final String contentType) {
		return isImageType(contentType) || isVideoType(contentType)
				|| isAudioType(contentType) || isVCardType(contentType);
	}
	...
	/**
	 * If the content type is a type which can be displayed in the conversation
	 * list as a preview.
	 */
	public static boolean isConversationListPreviewableType(
	...
	/**
	 * Given a filename, look at the extension and try and determine the mime
	 * type.
	 * 
	 * @param fileName
	 *            a filename to determine the type from, such as img1231.jpg
	 * @param contentTypeDefault
	 *            type to use when the content type can't be determined from the
	 *            file extension. It can be null or a type such as
