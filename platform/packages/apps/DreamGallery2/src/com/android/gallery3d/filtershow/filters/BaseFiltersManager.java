...
public abstract class BaseFiltersManager implements FiltersManagerInterface {
    ...
    // protected ArrayList<FilterRepresentation> mLooks = new ArrayList<FilterFxRepresentation>();
    protected ArrayList<FilterFxRepresentation> mLooks = new ArrayList<FilterFxRepresentation>();
    ...
    public ArrayList<FilterFxRepresentation> getLooks() {
        return mLooks;
    }
    // @}
    ...
    public void addBorders(Context context) {
        /* SPRD: fix bug 488267,no title when select borders @{ */
        int[] BordNameId = {
                R.string.border_4X5,
    ...
    public void addTools(Context context) {
        ...
        int[] textId = {
                ...
                R.string.rotate,
                R.string.mirror,
                // SPRD: Modify 20150629 Spreadst of bug448099, add image draw function
                R.string.imageDraw
        };
        ...
        // SPRD: fix bug 381585, remove draw function
