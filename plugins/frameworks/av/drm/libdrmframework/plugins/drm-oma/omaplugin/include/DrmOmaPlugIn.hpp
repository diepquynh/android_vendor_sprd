...
#ifndef __DRM_OMA_PLUGIN_H__
#define __DRM_OMA_PLUGIN_H__
...
namespace android {
    ...
    class DrmOmaPlugIn : public DrmEngineBase {

        class DrmConvertEntity {
        private:
            DcfCreator* mCreater;
            DmParser*   mParser;
        public:
            friend class DrmOmaPlugIn;
            DrmConvertEntity(DcfCreator* c, DmParser* p) : mCreater(c), mParser(p) {}
            virtual ~DrmConvertEntity() { delete mCreater; delete mParser; }
        };

    public:
        DrmOmaPlugIn();
        virtual ~DrmOmaPlugIn();
    ...
    private:
        ...
        static const String8 supportedFileSuffix[];
        RightsManager rightsManager;
        SessionMap<DcfParser*> decodeSessionMap;
        SessionMap<RightsConsumer*> consumeSessionMap;
        SessionMap<DrmConvertEntity*> mConvertSessionMap;
    };
};

#endif /* __DRM_OMA_PLUGIN_H__ */
