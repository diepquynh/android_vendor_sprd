...
public class ContactsDatabaseHelper extends SQLiteOpenHelper {
     ...
     * </pre>
     */
    static final int DATABASE_VERSION = 1112;
    ...
    private long mMimeTypeIdGroupMembership;
    ...
    private void initializeCache(SQLiteDatabase db) {
        ...
        //SPRD: Add for bug612001, Group is lost after contacts deduplication
        mMimeTypeIdGroupMembership = lookupMimeTypeId(GroupMembership.CONTENT_ITEM_TYPE, db);
        //SPRD: Add for bug606665, photo is lost after contacts deduplication
        mMimeTypeIdPhoto = lookupMimeTypeId(ContactsContract.CommonDataKinds.Photo.CONTENT_ITEM_TYPE, db);
    }
...
//        ");");
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        */
        ...
        //SPRD: add for bug617830, add fdn feature
        if (isUpgradeRequired(oldVersion, newVersion, 1112)) {
            upgradeViewsAndTriggers = true;
            oldVersion = 1112;
        }
    ...
    */
    private void upgradeToVersion1013(SQLiteDatabase db) {
        ...
        Cursor cursor = null;
        try {
            cursor = db.rawQuery("SELECT * FROM " + CallLogDatabaseHelper.Tables.CALLS + " LIMIT 0",
                    null);
    ...
    */
    ...
    //SPRD: Add for bug612001, Group is lost after contacts deduplication
    public long getMimeTypeIdForGroupMembership() {
        return mMimeTypeIdGroupMembership;
    }
    //SPRD: Add for bug606665, photo is lost after contacts deduplication
    public long getmMimeTypeIdPhoto() {
        return  mMimeTypeIdPhoto;}
}
