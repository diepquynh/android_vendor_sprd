...
static uint16_t golden_awb[GOLDEN_AWB_SIZE]={
                                       0x0070, /*R*/
                                       0x00c8, /*GR*/
                                       0x00c8, /*GB*/
                                       0x0076, /*B*/
};/*R,GR,GB,B*/
static uint16_t golden_lsc[4][GOLDEN_LSC_CHANNAL_SIZE]; /*lsc block struct*/
...
LOCAL int32_t construct_golden_data(cmr_uint param){
	...
	awb_golden_package(golden_data->block[0].offset + (uint8_t *)golden_data);
#endif
