...
#include "../libinotifytools/inotifytools.h"
...
#define compare(A,B) if (!_compare((long)(A), (long)(B), #A, #B, __FILE__, __LINE__, __PRETTY_FUNCTION__))return;
...
#define TEST_DIR "data/local/tmp/inotifytools_test"
