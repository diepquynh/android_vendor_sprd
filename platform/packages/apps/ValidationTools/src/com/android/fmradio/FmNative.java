...
public class FmNative {
    ...
    static native int  readRegParm(FmRegCtlParms para);
    static native int  writeRegParm(FmRegCtlParms para);
    static native int getTuneParm(FmSeekCriteriaParms para);
    static native int setTuneParm(FmSeekCriteriaParms para);
    static native int getAudioParm(FmAudioThresholdParms para);
    static native int setAudioParm(FmAudioThresholdParms para);
