 ...
 */
public class RotateTextViewHide extends TextView implements Rotatable {

    @SuppressWarnings("unused")
    private static final Log.Tag TAG = new Log.Tag("RotateTextViewHide");
    ...
    public RotateTextViewHide(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public RotateTextViewHide(Context context) {
        super(context);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mCurrentDegree != mTargetDegree) {
            ...
            if (time < mAnimationEndTime) {
                ...
                mCurrentDegree = mTargetDegree;
                if(mTargetDegree == 0 || mTargetDegree == 180){
                    super.setText(mContent);
                }
            }
        }
