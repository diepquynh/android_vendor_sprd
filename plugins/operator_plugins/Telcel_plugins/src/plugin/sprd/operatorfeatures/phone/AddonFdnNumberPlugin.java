package plugin.sprd.CallLogFdnName;
        ...
        if (mFdnListCache.size() > 0) {
            ...
            for (int i = 0; i < phoneCount; i++) {
                ...
                if (subscriptionInfo != null) {
                    ...
                    if (telephonyManager.getIccFdnEnabled(subId) && cache != null
                            && cache.size() > 0) {
                        fdnName = cache.get(number);
                        if (fdnName != null) {
                            return fdnName;
    ...
    private class QueryPreNumberTask extends AsyncTask<Object, Object, String> {
        ...
        protected String doInBackground(Object... params) {
            ...
            try {
                ...
                AddonFdnNumberPlugin.this.notifyAllListeners();
            }
            return "";
        }
