...
public class ThreadInfoActivity extends Activity{

    private static final String[] SORTHR = { "/system/bin/top", "-n", "1","-s","thr"};
    ...
    static final String TAG = "ThreadInfoActivity";
    ...
    private Runnable runnable = new Runnable() {
        ...
        public void run() {
            while(!paused){
                mResult = ShellUtils.sortThr(SORTHR);
