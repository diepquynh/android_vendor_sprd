...
public class AnimatedCircleDrawable extends Drawable {
    ...
    public void animateToSmallRadius() {
        /* SPRD: sometimes draw() method is called in a bit late, error will happen before mCanvasWidth
         * and mCanvasHeight have not been initialized. refer to bug 501384 @{
         */
