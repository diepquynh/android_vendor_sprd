 ...
 */
/* SPRD: Feature 254784,change the visibility of ItemInfo for OWNER_WIDGET. @{ */
public class ItemInfo {
     ...
     */
    protected long container = NO_ID;
     ...
     */
    protected int minSpanX = 1;

    /**
     * Indicates the minimum Y cell span.
     */
    protected int minSpanY = 1;

    /**
     * Indicates that this item needs to be updated in the db
     */
    protected boolean requiresDbUpdate = false;
     ...
     */
    protected int[] dropPos = null;
    /* @} */

    public int unreadNum = 0; // SPRD: Feature 255689, porting from Android.4.1
