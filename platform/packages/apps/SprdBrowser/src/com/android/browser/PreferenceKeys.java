...
public interface PreferenceKeys {
    ...
    static final String PREF_SAVE_PATH = "save_path";
    ...
    */
    ...
    /*@}*/
    static final String PREF_USER_AGENT_PLUGIN = "useragent_plugin";
    static final String PREF_HOMEPAGE_PLUGIN = "homepage_plugin";
    static final String PREF_STORAGE_PLUGIN = "storage_plugin";
}
