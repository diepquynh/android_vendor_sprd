...
public class WebCorpus extends MultiSourceCorpus {
    ...
    public CharSequence getHint() {
        ...
        //SPRD: Modify 20131018 Spreadst of 228602 add hint for search web
        //return null;
        return getContext().getText(R.string.corpus_hint_web);
    }

    private boolean isUrl(String query) {
        //SPRD: 496463 use Util.WEB_URL to replace Patterns.WEB_URL
        return Util.WEB_URL.matcher(query).matches();
    }
    ...
    protected class WebResult extends Result {
        ...
        public void fill() {
            ...
            if (browserResult != null && browserResult.getCount() > 0) {
                /*modify 20130322 Spreadst of 122950 the browserResult is not completely start */
                for (int i = 0; i < browserResult.getCount(); i++) {
                    add(new SuggestionPosition(browserResult, i));
                }
                /*modify 20130322 Spreadst of 122950 the browserResult is not completely end */
            }
