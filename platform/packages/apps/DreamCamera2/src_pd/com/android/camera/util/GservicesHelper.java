...
public class GservicesHelper {
    public static final String PERSIST_CAMERA_API = "persist.sys.camera.camera_api";
    ...
    public static boolean useCamera2ApiThroughPortabilityLayer(ContentResolver contentResolver) {
        ...
        /* Bug 549664: open the API1/API2 switch. @{
        return true;
        */
        boolean isNewApi = SystemProperties.getBoolean(PERSIST_CAMERA_API, true);
        return isNewApi;
        /* @} */
    }
