...
public class PhotoEditorView extends LinearLayout implements Editor {
    ...
    public void setSuperPrimary(boolean superPrimary) {
        /**
         * SPRD 515237 DUT shows close force popup while change contact image
         *Original code:
    ...
    protected void resetDefault() {
         ...
         */
        mPhotoImageView.setImageDrawable(
                ContactPhotoManager.getDefaultAvatarDrawableForContactEditorBase(getResources(), false, null));
        /**
         *
         */
        mHasSetPhoto = false;
