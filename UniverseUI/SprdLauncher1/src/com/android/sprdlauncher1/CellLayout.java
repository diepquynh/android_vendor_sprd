...
public class CellLayout extends ViewGroup {
    ...
    class ReorderHintAnimation {
        ...
        void animate() {
            ...
            if (va.getDurationScale() == 0.0f) va.setDurationScale(1.0f); /* @} */
            va.setDuration(DURATION);
...
out:            for (int i = x; i < x + spanX - 1 && x < xCount; i++) {
    ...
    void updateCellInfoScreen(int screen){
        this.mCellInfo.screen = screen;
    }
    /* @} */

    /**
     * @SPRD: For 3D view, get bitmap for the view. @{
     *
     * @param x The X-coordinate starting point of the view
     * @param y The Y-coordinate starting point of the view
     * @param width The width of the view
     * @param height The height of the view
     */
//    public Bitmap getViewBitmap(int x, int y, int width, int height) {
//        clearFocus();
//        setPressed(false);
//        Bitmap bitmap = null;
//        boolean willNotCache = this.willNotCacheDrawing();
//        setWillNotCacheDrawing(false);
////        Log.v(TAG, "getViewBitmap  setup");
...
//        }
//        try {
////            Log.v(TAG, "getViewBitmap build");
//            buildDrawingCache();
////            Log.v(TAG, "getViewBitmap  builded");
//            Bitmap cacheBitmap = getDrawingCache();
////            Log.v(TAG, "getViewBitmap  got");
//            if (cacheBitmap == null) {
//                Log.e(TAG, "failed getViewBitmap(" + this + ")", new RuntimeException());
//                return null;
//            }
...
//        }
////        Log.v(TAG, "getViewBitmap  recreate");
