...
public class DeleteDropTarget extends ButtonDropTarget {
    ...
    private boolean isAllAppsWidget(DragSource source, Object info) {
        if (source instanceof AppsCustomizePagedView) {
            if (info instanceof PendingAddItemInfo) {
                ...
                /* SPRD: Feature 254784,OWNER_WIDGET is one of AllAppsWidget. @{ */
    ...
    public static boolean willAcceptDrop(Object info) {
        if (info instanceof ItemInfo) {
            ...
            /* SPRD: Feature 254784,we should accept the drop of OWNER_WIDGET. @{ */
    ...
    public void onDragStart(DragSource source, Object info, int dragAction) {
        ...
        mActive = isVisible;
        resetHoverColor();
        Log.d("jxt", isVisible + Log.getStackTraceString(new Throwable()));
    ...
    public void onDragEnd() {
        super.onDragEnd();
        mActive = false;
        /* SPRD: fix bug296097 when dragging at the end ,DeleteDropTarget does not display. @{ */
    ...
    private void completeDrop(DragObject d) {
        ...
        /* SPRD: Feature 254784,if this is OWNER_WIDGET,delete it. @{ */
    ...
    /**
     * SPRD: Feature 254784,return if this is OWNER_WIDGET. @{
     *
     * @param d
     * @return boolean
     */
    private boolean isWorkspaceOrFolderOwnerWidget(DragObject d) {
        return isDragSourceWorkspaceOrFolder(d) && (d.dragInfo instanceof OwnerWidgetInfo);
    }
    /** @} */
