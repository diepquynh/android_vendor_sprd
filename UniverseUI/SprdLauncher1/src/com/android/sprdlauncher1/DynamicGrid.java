...
class DeviceProfile {
    ...
    DeviceProfile(Context context,
        ...
        /* SPRD: Feature 246704,Replace the orignal initialize of numRows and numColumns. @{
        ...
        */
        numRows = resources.getInteger(R.integer.config_workspace_rows);
        numColumns = resources.getInteger(R.integer.config_workspace_cols);
        /* @} */
        ...
        if(SystemProperties.get("ro.product.board.customer", "none").equalsIgnoreCase("cgmobile")){
            // cg 2014-05-05 sai.pan begin
            //iconSize = invDistWeightedInterpolate(minWidth, minHeight, points);
            iconSize = invDistWeightedInterpolate(minWidth, minHeight, points) + 5;
            // cg 2014-05-05 sai.pan end
        }else{
            iconSize = invDistWeightedInterpolate(minWidth, minHeight, points);
        }
        ...
        /* SPRD: Feature 246816,Replace the orignal initialize of numHotseatIcons. @{
        ...
        */
        numHotseatIcons = resources.getInteger(R.integer.config_hotseat_cols);
        /* @} */
        ...
        /* SPRD: Feature 246816,Change the rank of AllAppsBtn to right side. @{ */
        //hotseatAllAppsRank = (int) (numColumns / 2);
        hotseatAllAppsRank = (int) (numHotseatIcons - 1);
        /* @} */
        ...
        */
        ...
        /* SPRD: Fix bug 279588. fix bug329259, we use the icon_pre's size as standard. @{ */
        //folderBackgroundOffset = -edgeMarginPx;
        //folderIconSizePx = iconSizePx + 2 * -folderBackgroundOffset;
        folderBackgroundOffset = 0;
        Bitmap preIconBitmap = ((BitmapDrawable) context.getResources().getDrawable(R.drawable.icon_pre)).getBitmap();
        folderIconSizePx = preIconBitmap.getWidth();
        /* @} */
    ...
    void updateFromConfiguration(Resources resources, int wPx, int hPx,
        ...
        /* SPRD: Fix bug 303481. the layout of main menu in HVGA is too tight@{ */
        if (isLandscape) {
...
//            allAppsNumRows = (int) numRows + 1;
            allAppsNumRows = (int) numRows; //SPRD: Bug 256857,The application names display is not complete
            allAppsNumCols = (availableWidthPx - padding.left - padding.right - 2 * edgeMarginPx) /
                    (iconSizePx + 2 * edgeMarginPx) ;
            if(allAppsNumCols>allAppsNumRows)
                allAppsNumCols = allAppsNumCols-1;
        }
        /* @} */
    }
