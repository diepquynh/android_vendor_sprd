...
public class CaptureModule extends CameraModule implements
        ...
        public GestureDetector.OnGestureListener getGestureListener() {
            return new GestureDetector.SimpleOnGestureListener() {
                ...
                public boolean onSingleTapUp(MotionEvent ev) {
                    ...
                    if(sFreezeFrameControl.mFreezeVisible){
                        return false;
                    }
    ...
    public void init(CameraActivity activity, boolean isSecureCamera, boolean isCaptureIntent) {
        ...
        // SPRD:Add for Freeze
        //mAppController.getServices().getCaptureSessionManager().addSessionListener(mSessionListener);
        try {
        ...
        //SPRD:Add for freeze_display   477
        sFreezeFrameControl = new FreezeFrameDisplayControl(activity,mUI,false);
        sFreezeFrameControl.setListener(this);
    ...
    private void takePictureNow() {
        ...
        //mHandler.postDelayed(showFreezeRunnable, 1000);
    }
    ...
    public void onPictureSaved(Uri uri) {
        android.util.Log.i("lingyun","onPictureSaved");
            ...
            new SessionListener() {
                ...
                public void onSessionDone(final Uri sessionUri) {
                    ...
                    && sFreezeFrameControl.isFreezeFrame())) {
                        if (sessionUri != null) {
                            Uri mContentUri = Storage.getContentUriForSessionUri(sessionUri);
                            sFreezeFrameControl.proxyRunLoadProxy(mContentUri);
                        } else {
    ...
    private Runnable showFreezeRunnable = new Runnable() {
        public void run() {
            /* SPRD: ADD for FreezeDisplay */
            if (sFreezeFrameControl != null &&
                    sFreezeFrameControl.isFreezeFrame()) {
                mAppController.getCameraAppUI().setSwipeEnabled(false);
                sFreezeFrameControl.proxyAnimation(true, 0);
            }
        }
    };
