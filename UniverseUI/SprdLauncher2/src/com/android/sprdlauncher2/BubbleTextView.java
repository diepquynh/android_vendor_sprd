...
public class BubbleTextView extends TextView {
    ...
    /*SPRD : Modify this for bug 277967 ,to decide screen resolution is not hvga @{ */
    private Launcher mLauncher;
    private final static String RESOLUTION = "320*480";
    /* @} */

    public BubbleTextView(Context context) {
        super(context);
        mLauncher = (Launcher)context;//SPRD : Modify this for bug 277967 ,to decide screen resolution is not hvga
        init();
    }
    ...
    public void onFinishInflate() {
        ...
        /* SPRD: bug 305256, close the Hardware acceleration @{ */
    ...
    public void applyFromShortcutInfo(ShortcutInfo info, IconCache iconCache) {
        ...
        Bitmap b  = getShortcutIcon(info, iconCache);
        /* @} */
        LauncherAppState app = LauncherAppState.getInstance();
        DeviceProfile grid = app.getDynamicGrid().getDeviceProfile();
        ...
        /* SPRD : Modify this for bug 277967 ,to decide screen resolution is not hvga @{ */
        /* SPRD :  Modify this for bug 307315 , to avoid get DisplayMetrics at for loop*/
        if (!(LauncherAppState.mStrDisplayMetrics.equals(RESOLUTION)))
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                // to create it)
                /* SPRD: only do createGlowingOutline() when TARGET_LOWCOST_SUPPORT is false @{ */
                if (!LC_RAM_SUPPORT && (mPressedOrFocusedBackground == null)) {
                    mPressedOrFocusedBackground = createGlowingOutline(
    ...
    public void draw(Canvas canvas) {
        ...
        /* SPRD: Fix bug298132,optimize icon textview overdraw. @{ */
        super.draw(canvas);
    ...
    /* SPRD: Feature 259193, porting from Android.4.1 @{ */
    public Bitmap getShortcutIcon(ShortcutInfo info, IconCache iconCache){
      if(info.unreadNum == 0)
          return info.getIcon(iconCache);
      else
          return UnreadLoader.getBitmapWithNum(mContext, info, info.getIcon(iconCache));
    }
    /* @} */
}
