...
public class FilmstripLayout extends FrameLayout implements FilmstripContentPanel {
    ...
    // SPRD: Fix bug 535110, Photo voice record.
    private VoiceImageView mVoicePlayButton;
        ...
        public void onAnimationEnd(Animator animator) {
            if (!mCanceled) {
                if (mFilmstripContentTranslationProgress != 0f) {
                    ...
                    // SPRD: Fix bug 535110, Photo voice record.
                    setVoicePlayButtonVisible(false);
                } else {
                    notifyShown();
                }
            }
    ...
    public void onFinishInflate() {
        ...
        // SPRD: Fix bug 535110, Photo voice record.
        mVoicePlayButton = (VoiceImageView) findViewById(R.id.photo_voice_icon);
    }
    ...
    public void setVoicePlayButtonVisible(boolean visible) {
        mVoicePlayButton.setVisibility(visible ? View.VISIBLE : View.INVISIBLE);
    }

    public void startCircle() {
        mVoicePlayButton.startCircle();
    }

    public void stopCircle() {
        mVoicePlayButton.stopCircle();
    }

    public void setCircleDuration(long duration) {
        mVoicePlayButton.setDuration(duration);
    }
    /* @} */
}
