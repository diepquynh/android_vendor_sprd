...
public class ContactLoader extends AsyncTaskLoader<Contact> {
    ...
    private static class ContactQuery {
        ...
        public static final int CARRIER_PRESENCE = 67;
    }
    ...
    private Contact loadContactHeaderData(final Cursor cursor, Uri contactUri) {
        ...
        */
        ...
        final String sdnStr = cursor.getString(ContactQuery.SYNC1);
        ...
        return new Contact(mRequestedUri, contactUri, lookupUri, directoryId,
                lookupKey, contactId, nameRawContactId, displayNameSource,
                photoId, photoUri, displayName, altDisplayName, phoneticName,
                starred, presence, sendToVoicemail, customRingtone,
                isUserProfile, displayAccountName, displayAccountType,
                "sdn".equals(sdnStr), isFdn, fdnPhoneId);
        /**
         * @}
         */
    }
