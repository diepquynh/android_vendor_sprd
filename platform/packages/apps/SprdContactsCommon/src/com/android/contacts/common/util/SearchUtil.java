...
public class SearchUtil {
     ...
     * @{
     */
    public static MatchedLine findMatchingLine(String contents, String substring, Context context) {
...
//        }
         ...
         * @}
         */
        final int index = SegmentSearch.getInstance(context).getIndex(contents,substring);
        /*
         * @}
         */
        if (index != -1) {
