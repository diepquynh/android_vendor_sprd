...
class AccountTypeManagerImpl extends AccountTypeManager
    ...
    */
    ...
    public boolean findAasInContacts(Context context, String aasIndex, String aas) {
        ...
        /**
         * SPRD:Bug554757 close cursor in case of resource leak
         * Origina code: if (cursor != null &&
         * cursor.moveToFirst()) { return true; } return false;
         *
         * @{
         */
        boolean findAasContacts = false;
        try {
            if (cursor != null && cursor.moveToFirst()) {
                findAasContacts = true;
            }
        } catch (Exception e) {
