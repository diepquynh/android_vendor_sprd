        ...
        try {
            ...
            if (attachment.mUiDestination == UIProvider.AttachmentDestination.CACHE) {
                ...
                try {
                     ...
                     * original bug608146 bug425212 @{*/
                    long id = dm.addCompletedDownload(file.getName(), attachment.mFileName,
            ...
            // SPRD: Modify for bug625452 illegal filename issue
            LogUtils.e(Logging.LOG_TAG, e, "Mark Attachment State FAILED");
            /* @} */
