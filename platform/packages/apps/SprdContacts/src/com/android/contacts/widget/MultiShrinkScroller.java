    ...
    public void initialize(MultiShrinkScrollerListener listener, boolean isOpenContactSquare) {
        ...
        SchedulingUtils.doOnPreDraw(this, /* drawNextFrame = */ false, new Runnable() {
            ...
            public void run() {
                ...
                /* SPRD: Bug603595 Split screen when the screen, contact details of the interface, the contact head name and the number of overlapping. @{ */
                if (mMaximumHeaderTextSize == 0) {
                    mTitleAndPhoneticNameView.measure(0, 0);
                    mMaximumHeaderTextSize = mTitleAndPhoneticNameView.getMeasuredHeight();
                }
                /* @{ */
                if (mIsTwoPanel) {
