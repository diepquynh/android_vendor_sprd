...
class DeviceProfile {
    ...
    DeviceProfile(Context context,
        ...
        /* SPRD: Fix bug 283116. @{ */
        searchBarSpaceHeightPx = searchBarHeightPx + 4 * edgeMarginPx;
        /* @} */
    ...
    Rect getWorkspacePadding(int orientation) {
        return getWorkspacePadding(orientation, false);
    }
    Rect getWorkspacePadding(int orientation, boolean isEditMode) {
        ...
        if (orientation == CellLayout.LANDSCAPE &&
            ...
            if (isTablet()) {
                ...
                padding.set(desiredWorkspaceLeftRightMarginPx - defaultWidgetPadding.left,
                        isEditMode ? searchBarSpaceHeightPx / 3 : searchBarSpaceHeightPx / 2,
                        desiredWorkspaceLeftRightMarginPx - defaultWidgetPadding.right,
                        isEditMode ? hotseatBarHeightPx + pageIndicatorHeightPx + searchBarSpaceHeightPx *2 / 3: hotseatBarHeightPx + pageIndicatorHeightPx + searchBarSpaceHeightPx / 2);
            }
        }
        return padding;
    }
    ...
    /* SPRD: Fix bug 261340 @{ */
    public void layout(Launcher launcher, boolean isEditMode) {
        ...
        if (hasVerticalBarLayout) {
            ...
            searchBar.setPadding(
                    2 * edgeMarginPx,
                    isEditMode ? 2 * edgeMarginPx : 0,
                    2 * edgeMarginPx,  isEditMode ? 2 * edgeMarginPx : 4 * edgeMarginPx);
            /* @} */
        }
        ...
        */
        ...
        Rect padding = getWorkspacePadding(isLandscape
                ...
                : CellLayout.PORTRAIT, isEditMode);
        ...
        if (pageIndicator != null) {
            if (hasVerticalBarLayout) {
                ...
                // SPRD:fix269914
                lp.bottomMargin = isEditMode ? hotseatBarHeightPx + searchBarHeightPx : hotseatBarHeightPx + searchBarHeightPx / 2;
