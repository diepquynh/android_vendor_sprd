...
public class RawContactEditorView extends BaseRawContactEditorView {
    ...
    public void setState(RawContactDelta state, AccountType type, ViewIdGenerator vig,
         ...
         */
            /**
             * SPRD Bug503199 DUT fail to create new group in Jio sim card
             * @{
             */
            boolean isGroupMembershipEditable = type.isGroupMembershipEditable();
            mGroupMembershipKind = type.getKindForMimetype(GroupMembership.CONTENT_ITEM_TYPE);
            if (mGroupMembershipKind != null && isGroupMembershipEditable) {
