...
public class Folder extends LinearLayout implements DragSource, View.OnClickListener,
    ...
    public void animateOpen() {
        ...
        /* SPRD: Fix bug290020, @{ */
        if (ob.getDurationScale() < 1.0f) {
            ob.setDurationScale(1.0f);
        }
        /* @} */
        ...
        as.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationStart(Animator animation) {
                ...
                // SPRD: fix bug 276325,show folder in the middle of the screen.
                mLauncher.getWorkspace().getOpenFolder().setTranslationY(0);
            }
            @Override
            public void onAnimationEnd(Animator animation) {
                mState = STATE_OPEN;
                /* SPRD:fix bug276396, we add mOpenBg view below the opened folder in DragLayer
                 * while an exception occurred like bug276396. @{ */
                DragLayer parent = (DragLayer) getParent();
                /* SPRD: fix bug 293734, monkey crash: java.lang.NullPointerException @{ */
                if (parent != null) {
                    if (parent.indexOfChild(mOpenBg) < 0 && mOpenBg.getParent() == null) {
                        parent.addView(mOpenBg);
                        Folder.this.bringToFront();
                        Log.i(TAG, "The Exception of bug276396 occurred and we made it work correct.");
                    }
                } else {
    ...
    public void animateClosed() {
        ...
        as.addListener(new AnimatorListenerAdapter() {
            @Override
            public void onAnimationEnd(Animator animation) {
                /* SPRD: Fix bug279726, call function onCloseComplete() here perform better. @{ */
                onCloseComplete();
                /* @} */
                setLayerType(LAYER_TYPE_NONE, null);
                mState = STATE_SMALL;
            ...
            public void onAnimationStart(Animator animation) {
                ...
                mState = STATE_ANIMATING;
                /* SPRD: Fix bug279726, it's inappropriate to call function onCloseComplete() here. @{ */
                //onCloseComplete(); //SPRD:fix bug 276396,remove parent view on animation start
                /* @} */
            }
        });
        as.setDuration(mExpandDuration);
    ...
    public void onDropCompleted(final View target, final DragObject d,
        ...
        if (successfulDrop) {
            if (mDeleteFolderOnDropCompleted && !mItemAddedBackToSelfViaIcon) {
             // SPRD: fix bug258727,we remain the empty folder
        ...
        for (int j = 0; j < mContent.getCountY(); j++) {
            for (int i = 0; i < mContent.getCountX(); i++) {
                ...
                if (v != null) {
                    ...
                    Log.w(TAG,"getViewForInfo: v is null!");
                    continue;
                }
            }
        }
