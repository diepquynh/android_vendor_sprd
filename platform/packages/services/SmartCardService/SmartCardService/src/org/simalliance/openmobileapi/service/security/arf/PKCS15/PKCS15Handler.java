...
public class PKCS15Handler {
        ...
        throws Exception, PKCS15Exception, SecureElementException
    {
        ...
        Log.d(TAG, "updateACRules ACRulesPath > " + ByteArrayConverter.byteArrayToHexString(ACRulesPath));
        ...
        for(int ind=0;ind<CONTAINER_AIDS.length;ind++) {
            if (selectACRulesContainer(CONTAINER_AIDS[ind])) {
                ...
                if( mACMainPath==null){
                    ...
                    if( mPkcs15Path != null ) {
                        Log.d(TAG, "initACEntryPoint else if");
                        ...
                        Log.d(TAG, "initACEntryPoint else else");
                        acMainPath = mACMainPath;
                    }
                }
                Log.d(TAG, "initACEntryPoint mACMainPath: " + mACMainPath + " , acMainPath : " + acMainPath);
        ...
        throws PKCS15Exception,SecureElementException
    {
        ...
        Log.d(TAG, "selectACRulesContainer aid : " + aid + " , mSimAllianceAllowed : " + mSimAllianceAllowed + " , mSimIoAllowed : " + mSimIoAllowed);
        if (aid==null) {
            mArfChannel = null;
        ...
        // if an AID is given use logical channel.
            ...
            if(!mSimAllianceAllowed) {
                ...
                if ((mArfChannel=mSEHandle.openLogicalArfChannel(aid))==null) {
                    ...
                    Log.d(TAG, "selectACRulesContainer mPkcs15Path : " + aid + " , mACMainPath : " + mACMainPath);
