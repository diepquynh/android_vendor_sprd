 ...
 * {@hide}
 */
public class ResultExceptionSprd extends CatException {
    private ResultCodeSprd mResult;
    private int mAdditionalInfo;
    private String mExplanation;

    public ResultExceptionSprd(ResultCodeSprd result) {
        super();
    ...
    public ResultExceptionSprd(ResultCodeSprd result, String explanation) {
        this(result);
        mExplanation = explanation;
    }

    public ResultExceptionSprd(ResultCodeSprd result, int additionalInfo) {
        this(result);
    ...
    public ResultExceptionSprd(ResultCodeSprd result, int additionalInfo, String explanation) {
        this(result, additionalInfo);
        mExplanation = explanation;
    }

    public ResultCodeSprd result() {
        return mResult;
    }
