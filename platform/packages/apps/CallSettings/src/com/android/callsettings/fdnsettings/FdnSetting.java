...
public class FdnSetting extends PreferenceActivity
                ...
                case EVENT_PIN2_CHANGE_COMPLETE: {
                        ...
                        if (ar.exception != null) {
                            ...
                            if (mPinChangeState == PIN_CHANGE_PUK) {
                                ...
                                int phoneId = SubscriptionController.getInstance().getPhoneId(mSubscriptionInfoHelper.getSubId());
                                /* SPRD: add for bug586544 @{ */
                                //IccUriUtils.getInstance().resetPIN2RemainTimes(getBaseContext(), phoneId);
                                //IccUriUtils.getInstance().resetPUK2RemainTimes(getBaseContext(), phoneId);
                                /* @} */
                                updateRemainTimes();
    ...
    protected void onCreate(Bundle icicle) {
        ...
        mButtonEnableFDN.getEditText().setFilters(
                new InputFilter[] { new InputFilter.LengthFilter(8) });
        mButtonChangePin2.getEditText().setFilters(
                new InputFilter[] { new InputFilter.LengthFilter(8) });
        /* @} */
    ...
    /* SPRD: add for bug607392 @{ */
    @Override
    protected void onNewIntent(Intent intent) {
        super.onNewIntent(intent);
        /* SPRD: add for bug627955 @{ */
        mButtonEnableFDN.dismissDialog();
        mButtonChangePin2.dismissDialog();
        /* @} */
        ...
        if (mButtonFdnList != null) {
            mButtonFdnList.setIntent(mSubscriptionInfoHelper
                    .getIntent(FdnList.class));
        }
    }
    /* @} */

    /* SPRD: add for bug613585 @{ */
    @Override
