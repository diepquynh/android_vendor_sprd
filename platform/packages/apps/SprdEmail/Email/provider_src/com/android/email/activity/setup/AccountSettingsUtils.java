...
public class AccountSettingsUtils {
   ...
   /**
    ...
    public static void saveAddressToHistoryDB(Context context, String address, String type) {
        new SaveAddressTask(context).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, address, type);
    }
    ...
    static class SaveAddressTask extends AsyncTask<String, Void, Void> {
        private Context mContext;
        public SaveAddressTask(Context context) {
            mContext = context;
        }

        @Override
        protected Void doInBackground(String... params) {
            EmailAddress.saveAddress(mContext, params[0], params[1]);
            return null;
        }
    }
    /** @} */
