...
import com.android.sprd.telephony.uicc.IccCardStatusEx.PinState;
...
public class IccCardApplicationStatusEx {
    ...
    public enum PersoSubState{
        ...
        PERSOSUBSTATE_SIM_LOCK_FOREVER;
    ...
    public PersoSubState PersoSubstateFromRILInt(int substate) {
        ...
        switch(substate) {
            ...
            case 25: newSubState = PersoSubState.PERSOSUBSTATE_SIM_LOCK_FOREVER; break;
            default:
