...
public class SearchWidgetProvider extends BroadcastReceiver {
    ...
    private static SearchWidgetState getSearchWidgetState(Context context, int appWidgetId) {
        ...
        //SPRD: 502508 set intent for search icon
        state.setSearchIconIntent(qsbIntent);
    ...
    private static class SearchWidgetState {
        ...
        /* SPRD: 502508 add intent for search icon @{ */
        public void setSearchIconIntent(Intent corpusIndicatorIntent) {
...
//            // Corpus indicator
            /* modify 2012/11/14 the search widget can not click start */
            if (mCorpusIndicatorIntent != null) {
                setOnClickActivityIntent(context, views, R.id.search_icon,
                        mCorpusIndicatorIntent);
            }
            /* modify 2012/11/14 the search widget can not click end */
