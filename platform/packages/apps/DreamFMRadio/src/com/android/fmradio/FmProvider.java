...
public class FmProvider extends ContentProvider {
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        int rows = 0;
        /**
         * SPRD: bug522251, FM happends crash in high storage case. Original Android code: mSqlDb =
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        /**
         * SPRD: bug522251, FM happends crash in high storage case. Original Android code:
