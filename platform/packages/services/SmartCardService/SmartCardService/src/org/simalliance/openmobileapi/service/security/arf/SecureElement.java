...
public class SecureElement {
    ...
    public Channel openLogicalArfChannel(byte[] AID) {
        try {
            ...
            Log.d(SmartcardService.LOG_TAG, "openLogicalArfChannel as ALLOWED");
    ...
    public void setChannelAccessDenied(AID_REF_DO aid_ref_do) {
        Log.d(TAG,"setChannelAccessDenied " + aid_ref_do.toString());
        this.mArfHandler.getAccessRuleCache().setChannelAccessDenied( aid_ref_do);
    }

    public boolean conflictACCertHash(AID_REF_DO aid_ref_do, Hash_REF_DO hash_ref_do){
        Log.d(TAG,"conflictACCertHash aid_ref_do : " + aid_ref_do.toString() + " , hash_ref_do : " + hash_ref_do.toString());
        return this.mArfHandler.getAccessRuleCache().conflictACCertHash(aid_ref_do, hash_ref_do);
    }
}
