...
public abstract class PagedView extends ViewGroup implements ViewGroup.OnHierarchyChangeListener {
    ...
    private static final float DEFAULT_SLIDE_DAMPING_COEFFICIENT = 6.5f;
    ...
    /* SPRD: Feature 255891,porting this two variables for getScaledMeasuredWidth() from SprdLauncher(Android4.1). @{ */
    ...
    protected void init() {
        ...
        mTouchSlop = DEFAULT_TOUCH_SLOP_FOR_SLIDE_OPTIMIZATION;
    ...
    protected void snapToPageWithVelocity(int whichPage, int velocity) {
        ...
        duration = Math.round(DEFAULT_SLIDE_DAMPING_COEFFICIENT * 1000 * Math.abs(distance / velocity));
