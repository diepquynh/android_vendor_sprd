...
public class MessageModification {
     ...
     */
    /**
     * Saves a flag indicating the message is which priority.
     *
     * @param values the ContentValues that will be used to create or update the message
     * @param priority
     */
    public static void putMailPriority(ContentValues values, int priority) {
        values.put(MessageColumns.MAIL_PRIORITY, priority);
    }
    /*@}*/
}
