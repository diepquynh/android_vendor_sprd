...
public class MimeType {
     ...
     *@{
     */
    private static final String VIDEO_ATTACHMENT_CONTENT_TYPE = "video/*";
    /*@}*/
    ...
    public static String inferMimeType(String name, String mimeType) {
        ...
        if (TextUtils.isEmpty(extension)) {
             ...
             *@{
             */
            /* SPRD:Add for bug518038 {@ */
            } else if ("flv".equalsIgnoreCase(extension) || "f4v".equalsIgnoreCase(extension)) {
                return VIDEO_ATTACHMENT_CONTENT_TYPE;
            /*@}*/
            /* SPRD:Add for bug533684 {@ */
            } else if ("opus".equalsIgnoreCase(extension)) {
                return "audio/*";
            /*@}*/
            } else {
