...
CMR_LOGI("src size %d %d dst size %d %d rect %d %d %d %d",
		frame_params->input_size.w,
		frame_params->input_size.h,
		frame_params->output_size.w,
		frame_params->output_size.h,
		frame_params->input_rect.x,
		frame_params->input_rect.y,
		frame_params->input_rect.w,
		frame_params->input_rect.h);
