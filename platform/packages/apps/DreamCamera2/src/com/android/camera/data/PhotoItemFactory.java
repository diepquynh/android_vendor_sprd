...
public class PhotoItemFactory implements CursorToFilmstripItemFactory<PhotoItem> {
    ...
    public PhotoItem get(Cursor c) {
        ...
        if (data != null) {
            ...
            /* SPRD: Fix bug 621018 Delete edit, puzzle function @{ */
            if (data.getFilePath() != null && data.getFilePath().endsWith(".gif")){
                return new GifItem(mContext, mGlideManager, data, this);
            }
            /* @} */
