...
public class DataItem implements Collapser.Collapsible<DataItem> {
    ...
    public int getCarrierPresence() {
        /**
         * SPRD:Bug594294 The DUT accurs NullPointerException while getting carrier presence.
         * original:
        ...
        int value = 1;
        try {
            value = mContentValues.getAsInteger(Data.CARRIER_PRESENCE);
        } catch (NullPointerException e) {
            Log.d("DataItem", "NullPointerException e=" + e.toString());
        }
        return value;
        /*
         * @}
