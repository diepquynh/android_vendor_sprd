...
public class DataRowHandlerForPhoneNumber extends DataRowHandlerForCommonDataKind {
    ...
    public void appendSearchableData(IndexBuilder builder) {
         ...
         * SPRD: Bug611977 the segment search is required by cmcc
...
//        if (SegmentSearchSupport.getInstance(mContext).isSegmentSearchSupport() ||
//                (!SystemProperties.get("ro.operator").isEmpty()
//                && SystemProperties.get("ro.operator").equals("cmcc"))) {
            SegmentSearchSupport.getInstance(mContext).appendTokenForSegmentSearch(normalizedNumber, builder);
//        }
        /**
         * @}
         */
