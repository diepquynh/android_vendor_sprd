...
private:
  /* SPRD: compile problem on branch sprdroidn_pdk64_k310_full @{ */
  // SPRD: Fix bug 658822 panorama can not save the picture, set MosaicSizeCheck size limit value to 15
  #define LIMIT_SIZE_MULTIPLIER 5.0f * 2.0f * 1.5f
  #define LIMIT_HEIGHT_MULTIPLIER 2.5f
