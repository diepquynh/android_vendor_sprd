...
public class Utilities {
    ...
    /* SPRD:bug609773 modify begin @{ */
    public static boolean attachmentExists(Context context, Uri contentUri) {
        if (contentUri == null) {
            return false;
        } else {
            InputStream inStream = null;
            try {
                inStream = context.getContentResolver().openInputStream(contentUri);
                return true;
                ...
                try {
                    ...
                    LogUtils.w(LogUtils.TAG, " IO exception when contentUri exist.");
                }
            }
        }
    }
