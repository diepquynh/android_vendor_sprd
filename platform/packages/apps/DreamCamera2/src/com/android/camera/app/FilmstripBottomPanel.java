...
class FilmstripBottomPanel implements CameraAppUI.BottomPanel {
    ...
    private final View mMiddleFillerPuzzle; // SPRD: Add for bug 587448
    ...
    public FilmstripBottomPanel(AppController controller, ViewGroup bottomControlsLayout) {
        ...
        mMiddleFillerPuzzle = mLayout.findViewById(R.id.filmstrip_bottom_control_middle_filler_puzzle); // SPRD: Add for bug 587448
    ...
    private void updateMiddleFillerLayoutVisibility() {
        ...
        /* SPRD: Add for bug 587448 @{ */
        if (UCamUtill.isUcamPuzzleEnable()) {
            mMiddleFillerPuzzle.setVisibility(View.INVISIBLE);
        } else {
            mMiddleFillerPuzzle.setVisibility(View.GONE);
        }
        /* @} */
    }
