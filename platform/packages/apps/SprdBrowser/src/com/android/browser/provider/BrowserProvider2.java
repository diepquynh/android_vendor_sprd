...
public class BrowserProvider2 extends SQLiteContentProvider {
    ...
    final class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public DatabaseHelper(Context context) {
            ...
            Log.d(TAG,"BrowserProvider2 ----> DatabaseHelper start");
            setWriteAheadLoggingEnabled(true);
            Log.d(TAG,"BrowserProvider2 ----> DatabaseHelper end");
        }

        @Override
        public void onCreate(SQLiteDatabase db) {
            Log.d(TAG,"BrowserProvider2 -----> onCreate() start");
            ...
            Log.d(TAG,"BrowserProvider2 -----> onCreate() end");
        }
        ...
        private void addDefaultBookmarks(SQLiteDatabase db, long parentId) {
            ...
            CharSequence[] bookmarks = Custom.getBookmarkPlugin().getBookmarks();
            if (bookmarks == null) {
                bookmarks = res.getTextArray(R.array.bookmarks);
            }
            TypedArray preloads = Custom.getBookmarkPlugin().getPreloads();
            if(preloads == null ){
            ...
            try {
                ...
                for (int i = 0; i < size; i = i + 2) {
                    ...
                    try {
                         ...
                         *@{
                         */
                        thumb = Custom.getBookmarkPlugin().readRaw(thumbId);
                        if (thumb == null ) {
                            thumb = readRaw(res, thumbId);
                        }
                        /*@}*/
                    ...
                    try {
                         ...
                         *@{
                         */
                        favicon = Custom.getBookmarkPlugin().readRaw(faviconId);
                        if (favicon == null) {
                            favicon = readRaw(res, faviconId);
                        }
                        /*@}*/
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case BOOKMARKS: {
                ...
                if (cursor != null) {
                    //only notify necessary uri to avoid bookmarkpage flicker
                    cursor.setNotificationUri(getContext().getContentResolver(), uri);
                    cursor.setNotificationUri(getContext().getContentResolver(), Bookmarks.CONTENT_URI);
                    cursor.setNotificationUri(getContext().getContentResolver(), Browser.BOOKMARKS_URI);
                }
                return cursor;
            }
            ...
            case COMBINED: {
                ...
                Cursor cursor = qb.query(db, projection, selection, selectionArgs, groupBy,
                        null, sortOrder, limit);
                if (cursor != null) {
                    //only notify necessary uri to avoid historypage flicker
                    cursor.setNotificationUri(getContext().getContentResolver(), uri);
                    cursor.setNotificationUri(getContext().getContentResolver(), Bookmarks.CONTENT_URI);
    ...
    public int updateInTransaction(Uri uri, ContentValues values, String selection,
        ...
        switch (match) {
            ...
            case IMAGES: {
                ...
                //if url is not in history or bookmark, do not insert, or pruneImages will delete this record after all
                if (count == 0 && valid_url) {
