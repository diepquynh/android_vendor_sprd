...
public class ClearFrequentsDialog extends DialogFragment {
    ...
    private static String TAG = "ClearFrequentsDialog";
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final OnClickListener okListener = new OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                /**
                 * SPRD:Bug487598 Do not show IndeterminateProgressDialog when activity is finishing
                 * @{
                 */
                ...
                final AsyncTask<Void, Void, Void> task = new AsyncTask<Void, Void, Void>() {
                    ...
                    protected Void doInBackground(Void... params) {
                        /**
                         * SPRD:Bug606281 Crash happen when storage is full
