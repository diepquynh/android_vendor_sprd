...
int update_param_v2(struct sensor_raw_info *sensor_raw_ptr,unsigned char *sensor_name)
{
	...
	sprintf(filename[0],"/data/misc/cameraserver/sensor_%s_raw_param_common.c",sensor_name);
	sprintf(filename[1],"/data/misc/cameraserver/sensor_%s_raw_param_prv_0.c",sensor_name);
	sprintf(filename[2],"/data/misc/cameraserver/sensor_%s_raw_param_prv_1.c",sensor_name);
	sprintf(filename[3],"/data/misc/cameraserver/sensor_%s_raw_param_prv_2.c",sensor_name);
	sprintf(filename[4],"/data/misc/cameraserver/sensor_%s_raw_param_prv_3.c",sensor_name);
	sprintf(filename[5],"/data/misc/cameraserver/sensor_%s_raw_param_cap_0.c",sensor_name);
	sprintf(filename[6],"/data/misc/cameraserver/sensor_%s_raw_param_cap_1.c",sensor_name);
	sprintf(filename[7],"/data/misc/cameraserver/sensor_%s_raw_param_cap_2.c",sensor_name);
	sprintf(filename[8],"/data/misc/cameraserver/sensor_%s_raw_param_cap_3.c",sensor_name);
	sprintf(filename[9],"/data/misc/cameraserver/sensor_%s_raw_param_video_0.c",sensor_name);
	sprintf(filename[10],"/data/misc/cameraserver/sensor_%s_raw_param_video_1.c",sensor_name);
	sprintf(filename[11],"/data/misc/cameraserver/sensor_%s_raw_param_video_2.c",sensor_name);
	sprintf(filename[12],"/data/misc/cameraserver/sensor_%s_raw_param_video_3.c",sensor_name);
	sprintf(filename[13],"/data/misc/cameraserver/sensor_%s_raw_param_main.c",sensor_name);
