...
public class BrowserActivity extends Activity {
    ...
    private boolean mIsNavigationBarMenuShowing = false;
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (icicle != null) {
            mIsNavigationBarMenuShowing = icicle.getBoolean("isNavigationBarMenuShowing",false);
            Log.i(LOGTAG, "mIsNavigationBarMenuShowing = "+mIsNavigationBarMenuShowing);
        }
        /* }@ */
    ...
    protected void onStart() {
        super.onStart();
        Log.i(LOGTAG, "BrowserActivity.onStart: this=" + this);
        mController.onResume();
    }

    /*SPRD:597617 menu is invalid while multi window mode changed@{ */
    private static final int MSG_SHOW_NAVIGATIONBAR_MENU = 0;

    private Handler mPopMenuHandler = new Handler() {
        @Override
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MSG_SHOW_NAVIGATIONBAR_MENU:
                    mController.showNavigationBarMenu();
                    break;
            }
        }
    };
    ...
    protected void onResume() {
        ...
        if (mIsNavigationBarMenuShowing) {
            mIsNavigationBarMenuShowing = false;
            mPopMenuHandler.sendEmptyMessageDelayed(MSG_SHOW_NAVIGATIONBAR_MENU, 400);
        }
    }
    /*@}*/
    ...
    protected void onDestroy() {
        ...
        super.onDestroy();
        /*SPRD:597617 menu is invalid while multi window mode changed @{ */
        mPopMenuHandler.removeMessages(MSG_SHOW_NAVIGATIONBAR_MENU);
        /* }@ */
    ...
    public void onMultiWindowModeChanged(boolean isInMultiWindowMode) {
        ...
        if (isInMultiWindowMode) {
            ...
            mController.setFullscreen(BrowserSettings.getInstance().useFullscreen());
        }
    }
    /* }@ */
}
