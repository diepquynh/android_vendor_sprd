...
public class Keys {
    ...
    public static final String KEY_HIGH_ISO = "pref_high_iso_key"; /* SPRD: New Feature About High ISO */
    ...
    public static void setDefaults(SettingsManager settingsManager, Context context) {
        ...
        if (ApiHelper.IS_NEXUS_6 || CamcorderProfile.hasProfile(0, CamcorderProfile.QUALITY_2160P)) {
        ...
        if (mInfos2 != null && mInfos2.getAntibandAutoEnable()) {
            settingsManager.setDefaults(
                    KEY_CAMER_ANTIBANDING,
                    context.getString(R.string.pref_camera_antibanding_entryvalue_auto),
                    context.getResources().getStringArray(
                            R.array.pref_camera_antibanding_entryvalues));
            settingsManager.setDefaults(
                    KEY_VIDEO_ANTIBANDING,
                    context.getString(R.string.pref_camera_antibanding_entryvalue_auto),
                    context.getResources().getStringArray(
                            R.array.pref_camera_antibanding_entryvalues));
        } else {
        ...
        settingsManager.setDefaults(KEY_CAMERA_AI_DATECT, context
                .getString(R.string.pref_ai_detect_entry_value_face), context.getResources()
        ...
        settingsManager.setDefaults(KEY_CAMERA_FILTER_ENTERED, false);
        ...
        // SPRD: Fix bug 474860, Add for quick capture
        settingsManager.setDefaults(KEY_QUICK_CAPTURE,
                context.getString(R.string.pref_camera_quick_capture_entry_value_capture_with_back_camera),
                context.getResources().getStringArray(
                        R.array.pref_camera_quick_capture_entry_values));

        // SPRD: Fix Bug 535139, Feature: Video Color Effect
        settingsManager.setDefaults(KEY_VIDEO_COLOR_EFFECT, context
                .getString(R.string.pref_camera_color_effect_entry_value_none), context
                .getResources()
                .getStringArray(R.array.pref_camera_color_effect_entryvalues));

        // SPRD: Fix Bug 535139, Feature: Video White Balance
        settingsManager.setDefaults(KEY_VIDEO_WHITE_BALANCE, context
                .getString(R.string.pref_camera_whitebalance_default), context
                .getResources()
                .getStringArray(R.array.pref_camera_whitebalance_entryvalues));

        settingsManager.setDefaults(KEY_CAMERA_VGESTURE, false);  /* SPRD: Add for VGesture */

        /* SPRD: Fix Bug 534257 New Feature EIS&OIS @{ */
        settingsManager.setDefaults(KEY_EOIS_DC_BACK, true);
        settingsManager.setDefaults(KEY_EOIS_DC_FRONT, true);
        settingsManager.setDefaults(KEY_EOIS_DV_BACK, false);
        settingsManager.setDefaults(KEY_EOIS_DV_FRONT, false);
        /* @} */

        settingsManager.setDefaults(KEY_HIGH_ISO, false);

        /* SPRD: Fix bug 560276 reset scenery @{ */
        settingsManager.setDefaults(KEY_GIF_MODE_SWITCHER, false);
        settingsManager.setDefaults(KEY_SCENERY_MODE_RESET, false);
        /* @} */
        /* SPRD:Bug 535058 New feature: volume */
        settingsManager.setDefaults(KEY_CAMERA_VOLUME,
                context.getString(R.string.pref_camera_capture_model_one),
                context.getResources().getStringArray(R.array.pref_camera_volume_entryvalues));
    }
