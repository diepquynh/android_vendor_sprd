...
public class CharsetDetector {
    ...
    public CharsetMatch[] detectAll() {
        ...
        for (int i = 0; i < ALL_CS_RECOGNIZERS.size(); i++) {
            ...
            boolean active = (fEnabledRecognizers != null) ? fEnabledRecognizers[i]
     ...
     *            A declared encoding for the data, if available, or null or an
    ...
    /**
     * Get the names of all charsets supported by <code>CharsetDetector</code>
     * class.
     * <p>
     * <b>Note:</b> Multiple different charset encodings in a same family may
     * use a single shared name in this implementation. For example, this method
     * returns an array including "ISO-8859-1" (ISO Latin 1), but not including
     * "windows-1252" (Windows Latin 1). However, actual detection result could
     * be "windows-1252" when the input data matches Latin 1 code points with
     * any points only available in "windows-1252".
     *
    ...
    //
    private boolean fStripTags = // If true, setText() will strip tags from
                                 // input text.
    false;

    private boolean[] fEnabledRecognizers; // If not null, active set of charset
                                           // recognizers had
                                           // been changed from the default. The
                                           // array index is
                                           // corresponding to ALL_RECOGNIZER.
                                           // See setDetectableCharset().
    ...
    static {
        ...
        list.add(new CSRecognizerInfo(
                new CharsetRecog_Unicode.CharsetRecog_UTF_16_BE(), true));
        list.add(new CSRecognizerInfo(
                new CharsetRecog_Unicode.CharsetRecog_UTF_16_LE(), true));
        list.add(new CSRecognizerInfo(
                new CharsetRecog_Unicode.CharsetRecog_UTF_32_BE(), true));
        list.add(new CSRecognizerInfo(
                new CharsetRecog_Unicode.CharsetRecog_UTF_32_LE(), true));

        list.add(new CSRecognizerInfo(
                new CharsetRecog_mbcs.CharsetRecog_sjis(), true));
        list.add(new CSRecognizerInfo(
                new CharsetRecog_2022.CharsetRecog_2022JP(), true));
        list.add(new CSRecognizerInfo(
                new CharsetRecog_2022.CharsetRecog_2022CN(), true));
        list.add(new CSRecognizerInfo(
                new CharsetRecog_2022.CharsetRecog_2022KR(), true));
        list.add(new CSRecognizerInfo(
                new CharsetRecog_mbcs.CharsetRecog_euc.CharsetRecog_gb_18030(),
                true));
        list.add(new CSRecognizerInfo(
        ...
        list.add(new CSRecognizerInfo(
                ...
                true));
        list.add(new CSRecognizerInfo(
                new CharsetRecog_mbcs.CharsetRecog_big5(), true));

        list.add(new CSRecognizerInfo(
                new CharsetRecog_sbcs.CharsetRecog_8859_1(), true));
        list.add(new CSRecognizerInfo(
                new CharsetRecog_sbcs.CharsetRecog_8859_2(), true));
        list.add(new CSRecognizerInfo(
                new CharsetRecog_sbcs.CharsetRecog_8859_5_ru(), true));
        list.add(new CSRecognizerInfo(
                new CharsetRecog_sbcs.CharsetRecog_8859_6_ar(), true));
        list.add(new CSRecognizerInfo(
                new CharsetRecog_sbcs.CharsetRecog_8859_7_el(), true));
        list.add(new CSRecognizerInfo(
                new CharsetRecog_sbcs.CharsetRecog_8859_8_I_he(), true));
        list.add(new CSRecognizerInfo(
                new CharsetRecog_sbcs.CharsetRecog_8859_8_he(), true));
        list.add(new CSRecognizerInfo(
                new CharsetRecog_sbcs.CharsetRecog_windows_1251(), true));
        list.add(new CSRecognizerInfo(
                new CharsetRecog_sbcs.CharsetRecog_windows_1256(), true));
        list.add(new CSRecognizerInfo(
                new CharsetRecog_sbcs.CharsetRecog_KOI8_R(), true));
        list.add(new CSRecognizerInfo(
                new CharsetRecog_sbcs.CharsetRecog_8859_9_tr(), true));

        // IBM 420/424 recognizers are disabled by default
        list.add(new CSRecognizerInfo(
                new CharsetRecog_sbcs.CharsetRecog_IBM424_he_rtl(), false));
        list.add(new CSRecognizerInfo(
                new CharsetRecog_sbcs.CharsetRecog_IBM424_he_ltr(), false));
        list.add(new CSRecognizerInfo(
                new CharsetRecog_sbcs.CharsetRecog_IBM420_ar_rtl(), false));
        list.add(new CSRecognizerInfo(
                new CharsetRecog_sbcs.CharsetRecog_IBM420_ar_ltr(), false));

        ALL_CS_RECOGNIZERS = Collections.unmodifiableList(list);
    }

    /**
     * Get the names of charsets that can be recognized by this CharsetDetector
     * instance.
     *
     * @return an array of the names of charsets that can be recognized by this
     *         CharsetDetector instance.
     *
     * @internal
    ...
    /**
     * Enable or disable individual charset encoding. A name of charset encoding
     * must be included in the names returned by
     * {@link #getAllDetectableCharsets()}.
     *
     * @param encoding
     *            the name of charset encoding.
     * @param enabled
     *            <code>true</code> to enable, or <code>false</code> to disable
     *            the charset encoding.
     * @return A reference to this <code>CharsetDetector</code>.
     * @throws IllegalArgumentException
     *             when the name of charset encoding is not supported.
     *
     * @internal
     * @deprecated This API is ICU internal only.
     */
