/*
  ...
  /home/wim/bin/gengetopt -i app/climax/src/cli/climax_cmdline.ggo --output-dir=./app/climax/src/cli 
...
const char *gengetopt_args_info_full_help[] = {
  ...
  "  -f, --fs=samplerate           use specified samplerate in Herz\n                                  (default=`48000')",
  "      --i2s=inputnr             select i2s input 1 or 2  (default=`1')",
  "      --pll=pllin               select pll clock input BCK or WS\n                                  (default=`BCK')",
  ...
  "      --loadDrc=filename        read drc settings from saved file",
  "      --loadPatch=filename      rload patch from file",
  ...
  "      --ini2cnt                 Generate the container file from an ini file\n                                  <this>.ini to <this>.cnt",
    0
};
...
init_help_array(void)
{
  ...
  gengetopt_args_info_help[45] = gengetopt_args_info_full_help[49];
  gengetopt_args_info_help[46] = gengetopt_args_info_full_help[50];
  gengetopt_args_info_help[47] = gengetopt_args_info_full_help[51];
  gengetopt_args_info_help[48] = gengetopt_args_info_full_help[52];
  gengetopt_args_info_help[49] = gengetopt_args_info_full_help[53];
  gengetopt_args_info_help[50] = gengetopt_args_info_full_help[54];
  gengetopt_args_info_help[51] = gengetopt_args_info_full_help[55];
  gengetopt_args_info_help[52] = gengetopt_args_info_full_help[56];
  gengetopt_args_info_help[53] = gengetopt_args_info_full_help[57];
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->i2s_given = 0 ;
  args_info->pll_given = 0 ;
  ...
  args_info->loadDrc_given = 0 ;
  args_info->loadPatch_given = 0 ;
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->fs_arg = 48000;
  args_info->fs_orig = NULL;
  args_info->i2s_arg = 1;
  args_info->i2s_orig = NULL;
  args_info->pll_arg = gengetopt_strdup ("BCK");
  args_info->pll_orig = NULL;
  ...
  args_info->loadDrc_arg = NULL;
  args_info->loadDrc_orig = NULL;
  args_info->loadPatch_arg = NULL;
  args_info->loadPatch_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->calibrate_help = gengetopt_args_info_full_help[7] ;
  args_info->calibrateStereo_help = gengetopt_args_info_full_help[8] ;
  args_info->resetMtpEx_help = gengetopt_args_info_full_help[9] ;
  ...
  args_info->fs_help = gengetopt_args_info_full_help[17] ;
  args_info->i2s_help = gengetopt_args_info_full_help[18] ;
  args_info->pll_help = gengetopt_args_info_full_help[19] ;
  args_info->versions_help = gengetopt_args_info_full_help[21] ;
  args_info->register_help = gengetopt_args_info_full_help[22] ;
  args_info->register_min = 0;
  args_info->register_max = 0;
  args_info->regwrite_help = gengetopt_args_info_full_help[23] ;
  args_info->regwrite_min = 0;
  args_info->regwrite_max = 0;
  args_info->dump_help = gengetopt_args_info_full_help[24] ;
  args_info->dumpStereo_help = gengetopt_args_info_full_help[25] ;
  args_info->pin_help = gengetopt_args_info_full_help[26] ;
  args_info->diag_help = gengetopt_args_info_full_help[27] ;
  args_info->dumpmodel_help = gengetopt_args_info_full_help[28] ;
  args_info->dsp_help = gengetopt_args_info_full_help[29] ;
  args_info->tcoef_help = gengetopt_args_info_full_help[30] ;
  args_info->xmem_help = gengetopt_args_info_full_help[31] ;
  args_info->xmem_min = 0;
  args_info->xmem_max = 0;
  args_info->record_help = gengetopt_args_info_full_help[33] ;
  args_info->recordStereo_help = gengetopt_args_info_full_help[34] ;
  args_info->count_help = gengetopt_args_info_full_help[35] ;
  args_info->output_help = gengetopt_args_info_full_help[36] ;
  args_info->logger_help = gengetopt_args_info_full_help[37] ;
  args_info->load_help = gengetopt_args_info_full_help[39] ;
  args_info->splitparms_help = gengetopt_args_info_full_help[40] ;
  args_info->loadDrc_help = gengetopt_args_info_full_help[41] ;
  args_info->loadPatch_help = gengetopt_args_info_full_help[42] ;
  args_info->loadPreset_help = gengetopt_args_info_full_help[43] ;
  args_info->loadSpeaker_help = gengetopt_args_info_full_help[44] ;
  args_info->loadConfig_help = gengetopt_args_info_full_help[45] ;
  args_info->save_help = gengetopt_args_info_full_help[46] ;
  args_info->savePreset_help = gengetopt_args_info_full_help[47] ;
  args_info->saveSpeaker_help = gengetopt_args_info_full_help[48] ;
  args_info->saveConfig_help = gengetopt_args_info_full_help[49] ;
  args_info->server_help = gengetopt_args_info_full_help[50] ;
  args_info->client_help = gengetopt_args_info_full_help[51] ;
  args_info->slave_help = gengetopt_args_info_full_help[52] ;
  args_info->loop_help = gengetopt_args_info_full_help[53] ;
  args_info->verbose_help = gengetopt_args_info_full_help[54] ;
  args_info->trace_help = gengetopt_args_info_full_help[55] ;
  args_info->quiet_help = gengetopt_args_info_full_help[56] ;
  args_info->ini2cnt_help = gengetopt_args_info_full_help[57] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->i2s_orig));
  free_string_field (&(args_info->pll_arg));
  free_string_field (&(args_info->pll_orig));
  ...
  free_string_field (&(args_info->loadDrc_arg));
  free_string_field (&(args_info->loadDrc_orig));
  free_string_field (&(args_info->loadPatch_arg));
  free_string_field (&(args_info->loadPatch_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->i2s_given)
    write_into_file(outfile, "i2s", args_info->i2s_orig, 0);
  if (args_info->pll_given)
    write_into_file(outfile, "pll", args_info->pll_orig, 0);
  ...
  if (args_info->loadDrc_given)
    write_into_file(outfile, "loadDrc", args_info->loadDrc_orig, 0);
  if (args_info->loadPatch_given)
    write_into_file(outfile, "loadPatch", args_info->loadPatch_orig, 0);
  ...
  if (args_info->ini2cnt_given)
    write_into_file(outfile, "ini2cnt", 0, 0 );
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'v':	/* set volume step.  */
          ...
          break;
        case 'f':	/* use specified samplerate in Herz.  */
        
        
          if (update_arg( (void *)&(args_info->fs_arg), 
               &(args_info->fs_orig), &(args_info->fs_given),
              &(local_args_info.fs_given), optarg, 0, "48000", ARG_INT,
              check_ambiguity, override, 0, 0,
              "fs", 'f',
              additional_error))
            goto failure;
        ...
        case 0:	/* Long option with no short option */
          ...
          if (strcmp (long_options[option_index].name, "calibrateStereo") == 0)
          {
          ...
          /* select i2s input 1 or 2.  */
          else if (strcmp (long_options[option_index].name, "i2s") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->i2s_arg), 
                 &(args_info->i2s_orig), &(args_info->i2s_given),
                &(local_args_info.i2s_given), optarg, 0, "1", ARG_INT,
                check_ambiguity, override, 0, 0,
                "i2s", '-',
                additional_error))
              goto failure;
          ...
          /* select pll clock input BCK or WS.  */
          else if (strcmp (long_options[option_index].name, "pll") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->pll_arg), 
                 &(args_info->pll_orig), &(args_info->pll_given),
                &(local_args_info.pll_given), optarg, 0, "BCK", ARG_STRING,
                check_ambiguity, override, 0, 0,
                "pll", '-',
                additional_error))
              goto failure;
          ...
          /* read drc settings from saved file.  */
          else if (strcmp (long_options[option_index].name, "loadDrc") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->loadDrc_arg), 
                 &(args_info->loadDrc_orig), &(args_info->loadDrc_given),
                &(local_args_info.loadDrc_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "loadDrc", '-',
                additional_error))
              goto failure;
          ...
          /* rload patch from file.  */
          else if (strcmp (long_options[option_index].name, "loadPatch") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->loadPatch_arg), 
                 &(args_info->loadPatch_orig), &(args_info->loadPatch_given),
                &(local_args_info.loadPatch_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "loadPatch", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "ini2cnt") == 0)
          {
            ...
            if (update_arg( 0 , 
                 0 , &(args_info->ini2cnt_given),
                &(local_args_info.ini2cnt_given), optarg, 0, 0, ARG_NO,
                check_ambiguity, override, 0, 0,
                "ini2cnt", '-',
                additional_error))
              goto failure;
