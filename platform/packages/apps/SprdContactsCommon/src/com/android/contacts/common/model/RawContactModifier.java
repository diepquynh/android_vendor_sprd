...
public class RawContactModifier {
    ...
    public static ArrayList<EditType> getValidTypes(RawContactDelta state, DataKind kind) {
        return getValidTypes(state, kind, null, true, null, /*checkOverall=*/ true);
    }
    ...
    public static ArrayList<EditType> getValidTypes(RawContactDelta state, DataKind kind,
        ...
        return getValidTypes(state, kind, forceInclude, true, null, /*checkOverall=*/ true);
    }
        ...
        if (newAccountType == oldAccountType) {
                ...
                if (StructuredName.CONTENT_ITEM_TYPE.equals(mimeType)) {
                    ...
                    if (entryList != null && !entryList.isEmpty()) {
                        for (ValuesDelta entry : entryList) {
                            ...
                            if (values != null) {
                                /**
                                 * SPRD: bug600989 don't save group info when switch accounts
                                 * @{
                                 */
                                if (!GroupMembership.CONTENT_ITEM_TYPE
                                        .equals(mimeType)) {
                                    newState.addEntry(ValuesDelta
                                            .fromAfter(values));
                                }
                                /**
                                 * @}
            ...
            for (DataKind kind : newAccountType.getSortedDataKinds()) {
                 ...
                 */
                    ...
                    Log.d(TAG, "Don't save group info when switch accounts");
                /**
                 * @}
                 */
