...
public class ImportVCardActivity extends Activity {
    ...
    //  SPRD: Bug 598147 add
    private static final String SMEDIA_VCARD_URI_PREFIX = "content://media";
    ...
    private class ImportRequestConnection implements ServiceConnection {
        ...
        public void onServiceConnected(ComponentName name, IBinder binder) {
            ...
            // SPRD : BUG608412 change lauguage will crash when import from vcf
    ...
    private String getDisplayName(Uri sourceUri) {
        ...
        try {
            ...
            if (cursor != null && cursor.getCount() > 0 && cursor.moveToFirst()) {
                ...
                int indexDisplayName = cursor.getColumnIndex("_display_name");
        ...
        if (TextUtils.isEmpty(displayName)){
            /**
             * SPRD: Bug 599765 vcard name not correct
             * original:
            displayName = sourceUri.getLastPathSegment();
             * @{
             */
            displayName = getResources().getString(R.string.vcard_file_temp_name);
        }
        return displayName;
    }
    ...
    private boolean isStorageUri(Uri uri) {
        /**
         * SPRD: Bug 598147 The DUT occurs crash while importing vcard.
         * original:
        return uri != null && uri.toString().startsWith(STORAGE_VCARD_URI_PREFIX);
         * @{
         */
        return uri != null && (uri.toString().startsWith(STORAGE_VCARD_URI_PREFIX) ||
                uri.toString().startsWith(SMEDIA_VCARD_URI_PREFIX));
        /*
         * @}
         */
    }
