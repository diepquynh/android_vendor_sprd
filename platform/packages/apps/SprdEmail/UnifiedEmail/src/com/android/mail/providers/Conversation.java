...
public class Conversation implements Parcelable {
     ...
     */
    /**
     * @see UIProvider.ConversationColumns#MAIL_PRIORITY
     */
    ...
    public Conversation(Cursor cursor) {
         ...
         *@{
         */
        mailPriority = cursor.getInt(UIProvider.CONVERSATION_MAIL_PRIORITY_COLUMN);
        /*@}*/
    }
    ...
    public Conversation(Conversation other) {
         ...
         *@{
         */
        mailPriority = other.mailPriority;
        /*@}*/
    }
    ...
    private Conversation(long id, Uri uri, String subject, long dateMs,
         ...
         *@{
         */
        this.mailPriority = UIProvider.MailPriority.NORMAL;
        /*@}*/
    }
