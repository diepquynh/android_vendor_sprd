...
ump_handle ump_handle_create_from_phys_block(unsigned long phys_addr, unsigned long phys_size)
{
    ump_secure_id secure_id;
	ump_handle handle;

    secure_id = ump_arch_secure_id_from_phys_block(phys_addr, phys_size);
...
void ump_free_handle_from_mapped_phys_block(ump_handle handle)
{
    ump_secure_id secure_id;

    secure_id = ump_secure_id_get(handle);
