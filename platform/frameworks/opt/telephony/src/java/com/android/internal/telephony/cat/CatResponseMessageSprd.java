...
public class CatResponseMessageSprd {
    CommandDetailsSprd mCmdDet = null;
    ResultCodeSprd mResCode = ResultCodeSprd.OK;
    ...
    public CatResponseMessageSprd(CatCmdMessageSprd cmdMsg) {
        mCmdDet = cmdMsg.mCmdDet;
    }

    public void setResultCode(ResultCodeSprd resCode) {
        mResCode = resCode;
    }
    ...
    CommandDetailsSprd getCmdDetails() {
        return mCmdDet;
    }
