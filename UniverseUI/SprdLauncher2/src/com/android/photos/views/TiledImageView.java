...
public class TiledImageView extends FrameLayout {
    ...
    public void destroy() {
        Log.d("TiledImageView", "TiledImageView.destroy enter.");
        if (!IS_SUPPORTED) {
            return;
        }
        if (USE_TEXTURE_VIEW) {
        ...
        Log.d("TiledImageView", "TiledImageView.destroy exit.");
    }
    ...
    public void setTileSource(TileSource source, Runnable isReadyCallback, boolean resetScale) {
        if (!IS_SUPPORTED) {
            return;
        }
        synchronized (mLock) {

            /* SPRD: bug282443 2014-04-01 free texture generated previous @{ */
            if (mRenderer.source != null) {
                mGLSurfaceView
                        .queueEvent(new ReleaseTextureRunnable(mRenderer.source.getPreview()));
            }
            /* SPRD: bug282443 2014-04-01 free texture generated previous @} */
    ...
    /* SPRD: bug282443 2014-04-01 free texture generated previous @{ */
    private class ReleaseTextureRunnable implements Runnable {
