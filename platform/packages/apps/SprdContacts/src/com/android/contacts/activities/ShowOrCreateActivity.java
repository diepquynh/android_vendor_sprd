    ...
    public void onQueryComplete(int token, Object cookie, Cursor cursor) {
        ...
        if (count == 1 && contactId != -1 && !TextUtils.isEmpty(lookupKey)) {
            ...
            if (mCreateForce) {
                ...
                /**
                 * SPRD:Bug502454 When click high frequency, this may have a crash.
                 * SPRD:Bug507952 When click high frequency, and switch orientation at the same
                 * time, contacts anr
                ...
                if (!isFinishing()) {
                    try {
                        ...
                        Log.e(TAG, "Click too much : " + e.getMessage());
                    }
                }
                /**
                 * @}
