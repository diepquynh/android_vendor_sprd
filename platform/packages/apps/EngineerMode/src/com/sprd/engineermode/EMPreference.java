...
public class EMPreference extends Preference implements
     CompoundButton.OnCheckedChangeListener {
    final static String TAG = "EMPreference";
     ...
     * @param defStyle
     */
    public EMPreference(Context context, AttributeSet attrs, int defStyle) {
     ...
     * @param attrs
     */
    public EMPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
     ...
     * @param context
     */
    public EMPreference(Context context) {
        super(context);
        init();
    }
