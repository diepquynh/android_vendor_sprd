      ...
      if (flag == BSL_UART_PACKET) {
        ...
        head->length =
            cpu2be16((unsigned short)data_size);  // 2 bytes of message
                                                  ...
                                                  // message body!!!)
        crc16 = crc_16_l_calc((char *)head,
                              length);  // see above: length = sizeof(struct
