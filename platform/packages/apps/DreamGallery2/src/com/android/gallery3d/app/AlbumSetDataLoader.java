...
public class AlbumSetDataLoader {
    ...
    // SPRD: the status notify data will be loading
            ...
            public void handleMessage(Message message) {
                switch (message.what) {
                    ...
                    case MSG_LOAD_START:
                        ...
                        return;
                    /* SPRD: notify data will be loading. @{ */
                    case MSG_LOAD_WILL:
                        if (mLoadingListener != null) mLoadingListener.onLoadingWill();
                        return;
                    /* @} */
    ...
    private class ReloadTask extends Thread {
        ...
        public void run() {
            ...
            while (mActive) {
                ...
                // SPRD: if size change, and will loading, to notify
                if (info.size != mSize && info.size > 0) {
                    updateLoadingWill();
                }
    ...
    /**
     * SPRD: a notification interface data will change
     */
