...
public class PhoneNumberListAdapter extends ContactEntryListAdapter {
    ...
    public void configureLoader(CursorLoader loader, long directoryId) {
        ...
        if (isExtendedDirectory(directoryId)) {
            ...
            if (isSearchMode()) {
                ...
                /*SPRD: modify for bug625717 Dialer Crash when searching number in Guest mode
                 *
                 */
                if (isRemoteDirectoryQuery && getDirectoryById(directoryId) != null) {
                    builder.appendQueryParameter(ContactsContract.LIMIT_PARAM_KEY,
                ...
                /**
                 * SPRD: Bug612191 SIM contacts should not be searched to ECC
                 */
            ...
            if (!TextUtils.isEmpty(prevSelection)) {
                newSelection = prevSelection
                        ...
                        + " AND " + IGNORE_NUMBER_TOO_LONG_CLAUSE;
            } else {
    ...
    protected void bindView(View itemView, int partition, Cursor cursor, int position) {
        ...
        */
        if (isMultiPickerSupported()) {
            /**
             * 549112 it's difficult to choose or cancel contacts
             * @{
             */
            ...
            view.getCheckBox().setOnCheckedChangeListener(new OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    ...
                    if (null != onListCheckedChangeListener) {
                        onListCheckedChangeListener.onListCheckedChanged();
                    }
                }
            });
            /**
    ...
    protected void bindPhoneNumber(ContactListItemView view, Cursor cursor, boolean displayNumber,
        ...
        // SPRD: BUG 612085
        if (CompatUtils.isVideoCompatible()&&(mIsVideoCallShow != NOT_SHOW_VIDEO_CALL)) {
    ...
    /**
     * SPRD: BUG 612085 add videocallshow check for Dialer and other follow the google
     */
    private static final int DEFAULT_VIDEO_CALL = 0;
    private static final int SHOW_VIDEO_CALL = 1;
    private static final int NOT_SHOW_VIDEO_CALL = 2;
    private int mIsVideoCallShow = DEFAULT_VIDEO_CALL;

    public void setVideoCallShow(boolean isShow){
        mIsVideoCallShow = isShow?SHOW_VIDEO_CALL:NOT_SHOW_VIDEO_CALL;
    }
    /**
     * SPRD: BUG 612085
     */
