...
public class SystemLocaleUtils{
    private static final String LOG_TAG = "SystemLocaleUtils";
    private static final boolean DBG = true;

    public static void setSystemLocaleLock(String prefLang,String imsi,Context context){
        if (prefLang != null) {
            String country = null;
            if (imsi != null) {
