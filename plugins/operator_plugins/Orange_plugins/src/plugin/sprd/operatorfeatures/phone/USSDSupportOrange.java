package plugin.sprd.ussdsupportorange;
...
public class USSDSupportOrange extends USSDForOrangeUtils implements
        AddonManager.InitialCallback {

    private static final String LOGTAG = "USSDSupportOrange";
    private Context mAddonContext;

    public USSDSupportOrange() {
    }
