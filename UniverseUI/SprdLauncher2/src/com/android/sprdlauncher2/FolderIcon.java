...
import com.android.sprdlauncher2.FolderInfo.FolderListener;
 ...
 */
public abstract class FolderIcon extends LinearLayout implements FolderListener {
    ...
    /* SPRD: Fix bug 318951, default support multi language,I know this is a bad implement,
     * add a field in tab favorites of launcher.db will perform perfect.  @{ */
    public static final String DEFAULT_FOLDER_TOOLS = "multi_language_support_folder_tools";
    public static final String DEFAULT_FOLDER_SYSTEM = "multi_language_support_folder_system";
    public static final String DEFAULT_FOLDER_EMPTY = "multi_language_support_folder_empty";
    /* @} */
    ...
    static FolderIcon fromXml(int resId, Launcher launcher, ViewGroup group,
        ...
        folderInfo.title = folderInfo.title.equals("") ? launcher.getResources().getString(R.string.empty_folder_name) : folderInfo.title;
        if (DEFAULT_FOLDER_TOOLS.equals(folderInfo.title)) {
            folderInfo.title = launcher.getResources().getString(R.string.default_folder_tools);
        } else if (DEFAULT_FOLDER_SYSTEM.equals(folderInfo.title)){
            folderInfo.title = launcher.getResources().getString(R.string.default_folder_system);
        } else if (DEFAULT_FOLDER_EMPTY.equals(folderInfo.title)) {
            folderInfo.title = launcher.getResources().getString(R.string.empty_folder_name);
        }
        /* @} */
        ...
        /* SPRD: fix bug329259, Set the margin is consistent whit BubbleTextView. @{ */
        lp.bottomMargin = (int) ((grid.folderIconSizePx - grid.iconSizePx) / 2f);
        /* @} */
    ...
    private void onDrop(final ShortcutInfo item, DragView animateView, Rect finalRect,
        ...
        if (animateView != null) {
            ...
            if (!mLauncher.getWorkspace().mIsUnistalling){
                addItem(item);
            }
            mLauncher.getWorkspace().mIsUnistalling = false;
        }
    }
