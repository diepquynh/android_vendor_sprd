 ...
 *
 *    -c <mode>
 *    Slogmodem uses different configuration file with this option.
 *    slog_modem.conf in normal mode is used by default.
 *    <mode>_slog_modem.conf is used when this option is used.
 */
