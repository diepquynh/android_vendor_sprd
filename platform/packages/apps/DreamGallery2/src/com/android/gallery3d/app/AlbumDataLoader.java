...
public class AlbumDataLoader {
    ...
    public MediaItem get(int index) {
        if (!isActive(index)) {
            /* SPRD: fix bug 501600,IndexOutOfBoundsException @{ */
    ...
    private <T> T executeAndWait(Callable<T> callable) {
        ...
        try {
            ...
            // modify for bug513508 when the exception is thrown here,
            // it will cause crashing because of no dealing with it  @{
