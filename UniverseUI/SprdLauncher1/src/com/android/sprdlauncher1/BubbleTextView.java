...
//        Bitmap b = info.getIcon(iconCache);
        ...
        if(info.unreadNum == 0){
            ...
            b = UnreadLoader.getBitmapWithNum(mContext, info, info.getIcon(iconCache));
        }
        /* @} */
        LauncherAppState app = LauncherAppState.getInstance();
        DeviceProfile grid = app.getDynamicGrid().getDeviceProfile();
    ...
    public void draw(Canvas canvas) {
        ...
        /* SPRD: Fix bug332194, move appIcon from hotseat to workspace,text don't draw shadow. @{ */
        if(!getPaint().hasShadow) {
