...
public class UninstallShortcutReceiver extends BroadcastReceiver {
    ...
    private static void removeShortcut(Context context, Intent data) {
        ...
        if (intent != null && name != null) {
            ...
            // SPRD: fix bug294658
            final int itemType = c.getColumnIndexOrThrow(LauncherSettings.Favorites.ITEM_TYPE);
            ...
            try {
                while (c.moveToNext()) {
                    try {
                        // SPRD: fix bug294658
                        if (intent.filterEquals(Intent.parseUri(c.getString(intentIndex), 0)) && itemType == LauncherSettings.Favorites.ITEM_TYPE_SHORTCUT) {
