...
public class PhoneUi extends BaseUi {
    ...
    public void onDestroy() {
        ...
        if (showingNavScreen() && showingNavScreenMenu()) {
            if (mNavScreen != null)
                mNavScreen.dismissMenu();
        }
        /*@}*/
    }
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if (mNavScreen != null) {
            mNavScreen.onConfigurationChanged(newConfig);
        }
    }
    ...
    /*SPRD:597617 menu is invalid while multi window mode changed@{ */
    public boolean showingNavScreenMenu() {
        return mNavScreen != null && mNavScreen.isMenuShowing();
    }
    /*@}*/
    ...
    public void updateMenuState(Tab tab, Menu menu) {
        ...
        if ((abm != null) && (mTabControl != null) && (mTabControl.getCurrentTab() != null)) {
            ...
            if(mTabControl.getCurrentTab().getWebView() != null) {
                isSiteNavigation = SiteNavigation.SITE_NAVIGATION.equals(mTabControl.getCurrentTab().getWebView().getUrl());
            }
            abm.setVisible((tab != null) && !tab.isSnapshot() && !showingNavScreen()
                    && !isSiteNavigation);
        }
    ...
    void showNavScreen() {
        ...
        if(mActiveTab == null ){
            ...
            //return will cause input block, delete
            //return ;
        }
        if(mActiveTab != null ){
            mActiveTab.capture();
