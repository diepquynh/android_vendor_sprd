...
public interface IImage {
    ...
    public abstract void rename(String title);
    ...
    public abstract Bitmap getCachedThumbBitmap();
    public abstract Bitmap getMicroCachedThumbBitmap();

    // Get the bitmap of the mini thumbnail.
//    public abstract Bitmap miniThumbBitmap();
    public abstract Object[] miniThumbBitmap();
    public abstract Object[] microBottomThubmBitmap();
