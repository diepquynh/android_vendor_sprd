...
public class FmManagerForBrcm implements IFmProxyCallback {
    ...
    /**
     * proxy is Unavailable. mostly likely because FM service crashed in this case we need to force
     * the call to onDestroy() to avoid sending any Fm commands to the proxy.
     */
