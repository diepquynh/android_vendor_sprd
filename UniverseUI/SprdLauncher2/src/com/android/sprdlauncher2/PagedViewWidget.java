...
public class PagedViewWidget extends LinearLayout {
    ...
    protected void onFinishInflate() {
        ...
        setWidgetHVIndicatorBgResource(R.drawable.widget_hv0);
        /* @} */
    }
    ...
    public void applyFromAppWidgetProviderInfo(AppWidgetProviderInfo info,
        ...
        int index = (cellSpan[1] - 1) * 4 + cellSpan[0] - 1;
        setWidgetHVIndicatorBgResource(R.drawable.widget_hv0 + index);
        /* @} */
    ...
    public void applyEmptyFolderInfo(WidgetPreviewLoader holoOutlineHelper){
        mWidgetPreviewLoader = holoOutlineHelper;
        CharSequence label = getResources().getText(R.string.empty_folder_widget_name);
        final ImageView image = (ImageView) findViewById(R.id.widget_preview);
    ...
    /* SPRD: code separation 289582 @{ */
    public void setWidgetHVIndicatorBgResource(int resource){
        final ImageView dims = (ImageView) findViewById(R.id.widget_hv_indicator);
        if (dims != null) {
            /* SPRD: fix bug 267682,android.content.res.Resources$NotFoundException@{
            dims.setBackgroundDrawable(getResources().getDrawable(
                    R.drawable.widget_hv0 + index)); */
            Log.d("PagedViewWidget","applyFromAppWidgetProviderInfo index = "+
                    (resource - R.drawable.widget_hv0));
            try {
                dims.setBackgroundDrawable(getResources().getDrawable(resource));
            } catch (Exception e) {
                dims.setBackgroundDrawable(getResources().getDrawable(
                        R.drawable.widget_hv0 ));
                e.printStackTrace();
            }
            /* @} */
        }
