...
public class GeolocationPermissionsPrompt extends RelativeLayout {
    ...
    private TextView mRememberPrompt;
    private Button mShareButton;
    private Button mDontShareButton;
    private CheckBox mRemember;
    private GeolocationPermissions.Callback mCallback;
    private String mOrigin;
    private String mMessOrigin;
    ...
    private void init() {
        ...
        mRememberPrompt = (TextView) findViewById(R.id.prompt_remember);
    ...
    public void show(String origin, GeolocationPermissions.Callback callback) {
        ...
        mMessOrigin = "http".equals(uri.getScheme()) ?  mOrigin.substring(7) : mOrigin;
        setMessage(mMessOrigin);
    ...
    public void reShowPrompt() {
        mShareButton.setText(getResources().getString(R.string.geolocation_permissions_prompt_share));
        mDontShareButton.setText(getResources().getString(R.string.geolocation_permissions_prompt_dont_share));
        mRememberPrompt.setText(getResources().getString(R.string.geolocation_permissions_prompt_remember));
        setMessage(mMessOrigin);
    }
    /* }@ */
