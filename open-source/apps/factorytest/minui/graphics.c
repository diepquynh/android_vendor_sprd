...
void gr_camera_flip(char flag)
{
  ...
  if (vi.bits_per_pixel == 16) {
	for(i=0; i<(height>>3); i++){
	  memset(gr_framebuffer[gr_active_fb].data+(width*(height-(height>>3)+i))*2,0, (height>>3) * 2);
	  memcpy(gr_framebuffer[gr_active_fb].data+(width*(height-(height>>3)+i))*2, gr_mem_surface.data+(width*(height-(height>>3)+i))*2,
			 (height>>3) * 2);
	  memcpy(gr_framebuffer[gr_active_fb].data+(width*(height-(height>>3)+i)+(width-(height>>3)))*2, gr_mem_surface.data+(width*(height-(height>>3)+i)+(width-(height>>3)))*2,
			 (height>>3) * 2);
	  if(1 == flag){
			 memcpy(gr_framebuffer[gr_active_fb].data+(width*(height-(height>>3)+i)+(width/2-(height>>4)))*2, gr_mem_surface.data+(width*(height-(height>>3)+i)+(width/2-(height>>4)))*2,
			 (height>>3) * 2);
	  }
	}
  } else {
	for(i=0; i<(height>>3); i++){
	  memset(gr_framebuffer[gr_active_fb].data+(width*(height-(height>>3)+i))*4,0, (height>>3) * 4);
	  memcpy(gr_framebuffer[gr_active_fb].data+(width*(height-(height>>3)+i))*4, gr_mem_surface.data+(width*(height-(height>>3)+i))*4,
			 (height>>3) * 4);
	  memcpy(gr_framebuffer[gr_active_fb].data+(width*(height-(height>>3)+i)+(width-(height>>3)))*4, gr_mem_surface.data+(width*(height-(height>>3)+i)+(width-(height>>3)))*4,
			 (height>>3) * 4);
	  if(1 == flag){
			 memcpy(gr_framebuffer[gr_active_fb].data+(width*(height-(height>>3)+i)+(width/2-(height>>4)))*4, gr_mem_surface.data+(width*(height-(height>>3)+i)+(width/2-(height>>4)))*4,
			 (height>>3) * 4);
	  }
	}
  }
