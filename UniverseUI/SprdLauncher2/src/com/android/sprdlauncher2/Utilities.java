...
final class Utilities {
    ...
    /* SPRD: bug328858 2014-07-01 code refactor. @{ */
    private static final int icons_back = R.drawable.icon_back;
    private static final int icons_pre = R.drawable.icon_pre;
    private static final int icons_top = R.drawable.icon_top;

    private static SoftReference<BitmapDrawable> sBackIconDrawable;
    private static SoftReference<BitmapDrawable> sPreIconDrawable;
    private static SoftReference<Bitmap> sBackIconBitmap;
    private static SoftReference<Bitmap> sPreIconBitmap;
    /* SPRD: bug328858 2014-07-01 code refactor. @} */
    ...
    static {
        ...
        /* SPRD: bug328858 2014-07-01 code refactor. @{ */
        sPreIconDrawable = new SoftReference<BitmapDrawable>(null);
        sBackIconDrawable = new SoftReference<BitmapDrawable>(null);
        sPreIconBitmap = new SoftReference<Bitmap>(null);
        sBackIconBitmap = new SoftReference<Bitmap>(null);
        /* SPRD: bug328858 2014-07-01 code refactor. @} */
    }
    ...
    private static void initStatics(Context context) {
        ...
        @{ */
        /* SPRD: bug328858 2014-07-01 code refactor. @{ */
        BitmapDrawable preDrawable = sPreIconDrawable.get();
        if (preDrawable == null) {
            preDrawable = (BitmapDrawable)context.getResources().getDrawable(icons_pre);
            sPreIconDrawable = new SoftReference<BitmapDrawable>(preDrawable);
        }
        Bitmap preBitmap = sPreIconBitmap.get();
        if (preBitmap == null) {
            preBitmap = preDrawable.getBitmap();
            sPreIconBitmap = new SoftReference<Bitmap>(preBitmap);
        }
    ...
    /* SPRD: bug334366 2014-07-17 resize app icon to the same with resource icon_pre. @{ */
    ...
    static Bitmap createIconBitmap(Drawable icon, Context context, boolean back){
        ...
        synchronized (sCanvas) { // we share the statics :-(
            ...
            if (back && sNeedComposeIcon == NEED_COMPOSE_ICON) {
                ...
                BitmapDrawable backDrawable = sBackIconDrawable.get();
                if (backDrawable == null) {
                    backDrawable = (BitmapDrawable)context.getResources().getDrawable(icons_back);
                    sBackIconDrawable = new SoftReference<BitmapDrawable>(backDrawable);
                }

                Bitmap backBitmap = sBackIconBitmap.get();
                if (backBitmap == null) {
                    backBitmap = backDrawable.getBitmap();
                    sBackIconBitmap = new SoftReference<Bitmap>(backBitmap);
                }

                Bitmap resizedIcon = getStandardBitmap(icon, width, height);
                // compounds back bitmap and resized icon
                BitmapDrawable compoundDrawable = SprdUtilities.getCompoundedDrawable(backBitmap, resizedIcon);
                icon = SprdUtilities.compoundPreBitmap(compoundDrawable.getBitmap(), preBitmap);
                /* SPRD: bug328858 2014-07-01 code refactor. @} */
            }
