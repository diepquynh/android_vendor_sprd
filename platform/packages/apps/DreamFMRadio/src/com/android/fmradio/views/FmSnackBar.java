...
/**
 * The view used to display the customized toast Usage: FmSnackBar snackBar =
 * FmSnackBar.make(context, title, action, listener,FmSnackBar.DEFAULT_DURATION); snackBar.show();
 * snackBar.dismiss();
 */
public final class FmSnackBar extends View {
    ...
    /**
     * The callback listener, it will called while the action button was set and the action button
     * was clicked
     */
