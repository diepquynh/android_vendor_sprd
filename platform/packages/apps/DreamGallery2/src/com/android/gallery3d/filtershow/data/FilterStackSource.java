...
public class FilterStackSource {
    ...
    private boolean mIsDBOpen = true;
    ...
    public void open() {
        try {
            ...
            /* SPRD: Modify for bug610104, Gallery crash if database is null caused by SQLiteException @{ */
            // so try to finish FiltershowActivity and show toast.
            mIsDBOpen = false;
            Toast.makeText(mActivity, R.string.database_exception, Toast.LENGTH_SHORT).show();
            mActivity.finish();
            /* @} */
        }
    }
    ...
    /* SPRD: bug610104, Gallery crash if database is null caused by SQLiteException @{ */
    public boolean hasOpenDB() {
        return mIsDBOpen;
    }
    /* @} */
