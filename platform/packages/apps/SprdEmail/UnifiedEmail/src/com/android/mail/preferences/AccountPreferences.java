...
public class AccountPreferences extends VersionedPrefs {
    ...
    public static final class PreferenceKeys {
        ...
        private static final String SIGNATURE_ENABLE = "signature-enabled";
    ...
    public boolean getSignatureEnabled() {
        return getSharedPreferences().getBoolean(PreferenceKeys.SIGNATURE_ENABLE, true);
    }

    public void setSignatureEnabled(final boolean enabled) {
        getEditor().putBoolean(PreferenceKeys.SIGNATURE_ENABLE, enabled).apply();
    }
    /* @} */
}
