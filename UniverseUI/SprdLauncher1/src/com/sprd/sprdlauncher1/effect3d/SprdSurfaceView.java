...
//        private final static float FLING_VELOCITY_LIMIT = 400.0F;
        ...
        public void onFling(float velocityX, float velocityY) {
            if (null != mModle) {
                ...
                Log.w(TAG, "onFling - modle is null.");
                mCallback.onPreClose(0);
                mCallback.onClosing(0);
                mCallback.onClose(0);
            } else {
                Log.w(TAG, "all is null.");
            }
        }
...
//            Log.w(TAG, "--------onSurfaceCreated()--------");
        ...
        public void onActionDown(float x, float y) {
            if (null != mModle) {
                ...
                Log.w(TAG, "onActionDown - modle is null.");
            }
        }
        ...
        public void onActionMove(float x, float y) {
            if (null != mModle) {
                ...
                Log.w(TAG, "onActionMove - modle is null.");
            }
        }

        public void onActionUp() {
            if (null != mModle) {
                Log.w(TAG, "onActionUp");
                mModle.onStopMoving();
            } else if (null != mCallback) {
                Log.w(TAG, "onActionUp - modle is null.");
                mCallback.onPreClose(0);
                mCallback.onClosing(0);
                mCallback.onClose(0);
            }
