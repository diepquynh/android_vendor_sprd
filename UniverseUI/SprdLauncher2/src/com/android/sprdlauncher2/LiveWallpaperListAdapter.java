...
public class LiveWallpaperListAdapter extends BaseAdapter implements ListAdapter {
    ...
    //SPRD : fix bug259547
    private static final String VIDEO_WALLPAPER_SERVICE_NAME = "com.sprd.videoswallpapers.VideoWallpaperService";
    ...
    private class LiveWallpaperEnumerator extends
        ...
        protected Void doInBackground(List<ResolveInfo>... params) {
            ...
            for (ResolveInfo resolveInfo : list) {
                ...
                /* SPRD: fix bug259547 @{ */
                if (VIDEO_WALLPAPER_SERVICE_NAME.equals(info.getServiceName())) {
                    Log.d(LOG_TAG, "do not add video wallpaper service");
                    continue;
                }
                /* @} */
