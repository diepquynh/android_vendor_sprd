...
public class LauncherAppState {
    ...
    private static final String SHARED_PREFERENCES_KEY = "com.android.sprdlauncher2.prefs";
    ...
    // SPRD: add for bug 270979
    private static final String FIRST_BOOT = "first_boot";
    // SPRD: add for bug 307315
    public static String mStrDisplayMetrics;
    ...
    private LauncherAppState() {
        ...
        // SPRD: code separation 289776
        mIconCache = new SprdIconCache(sContext);
        // SPRD: init mStrDisplayMetrics
        mStrDisplayMetrics = getScreenResolution();

        mAppFilter = AppFilter.loadByName(sContext.getString(R.string.app_filter_class));
        mModel = new SprdLauncherModel(this, mIconCache, mAppFilter);
        ...
        sContext.registerReceiver(mModel, filter);
        /* SPRD: Feature 259193, porting from Android.4.1 @{ */
        mUnreadLoader = SprdReceiverOperation.registerReceiverUnreadLoader(sContext);
        /* @} */
        /* SPRD: for STK policy @{ */
        filter = new IntentFilter();
        filter.addAction(LauncherModel.ACTION_PACKAGE_CHANGED_LAUNCHER);
        sContext.registerReceiver(mModel, filter);
        /* @} */

        /* SPRD: bug309463 2014-05-08 reset wallpaper dimension if needed. @{ */
        filter = new IntentFilter();
        filter.addAction(SprdLauncherModel.RESET_WALLPAPER_DIM_ACTION);
        sContext.registerReceiver(mModel, filter);
        /* SPRD: bug309463 2014-05-08 reset wallpaper dimension if needed. @} */
    ...
    public void onTerminate() {
        ...
        /* SPRD: Feature 259193, porting from Android.4.1 @{ */
        SprdReceiverOperation.unregisterReceiverUnreadLoader(sContext, mUnreadLoader);
        /* @} */
    ...
    LauncherModel setLauncher(Launcher launcher) {
        /* SPRD: Feature 259193, porting from Android.4.1 @{ */
        if (mModel == null || mUnreadLoader==null) {
            throw new IllegalStateException("setLauncher() called before init()");
        }
        mModel.initialize(launcher);
        SprdReceiverOperation.initializeUnreadLoader(launcher, mUnreadLoader);
        /* @} */
        return mModel;
    }
    ...
    /**
     * SPRD: get DisplayMetrics @{
     * @return DisplayMetrics
     */
    public String getScreenResolution() {
        DisplayMetrics dm = sContext.getResources().getDisplayMetrics();
        mStrDisplayMetrics = dm.widthPixels + "*" + dm.heightPixels;
        Log.d("TAG", "ScreenResolution" + mStrDisplayMetrics);
        return mStrDisplayMetrics;
     }
     /* @} */
