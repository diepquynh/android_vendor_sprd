...
public class GroupMembershipView extends LinearLayout
     ...
     * @{
     */
    public void setIsCreateNewGroup(Cursor cursor,RawContactDeltaList state) {
        for (RawContactDelta mstate :state) {
    ...
    private void updateView() {
         ...
         * @{
         */
        /*SPRD: Bug603265 can not show the group section when edit the contact of exchange account*/
        if (!mAccountHasGroups && SimAccountType.ACCOUNT_TYPE.equals(mAccountType)) {
            setVisibility(GONE);
            return;
        }
        /**
    ...
    public void onClick(View v) {
        ...
        /**
         * SPRD:Bug 605051 at split mode ,show error
         *
         * @{
         */
        mPopup.setWidth(getResources().getDimensionPixelOffset(R.dimen.group_list_popup_window_width));
        /**
         * @}
         */
    ...
    protected void onDetachedFromWindow() {
        ...
        /**
         * SPRD:Bug 644687 it occured crash when edit group under split-screen
         * @{
         */
        mCreatedNewGroup = false;
        /**
    ...
    private boolean isCreateNewGroup() {
        ...
        if (getContext() != null
                && ((Activity) getContext() instanceof ContactEditorActivity)) {
            newGroup = ((ContactEditorActivity) getContext())
                    .getCreateNewGroup();
