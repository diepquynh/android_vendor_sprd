...
public class GifPhotoUI extends DreamGifUI {

    private ImageButton mSettingsButton;
    private View topPanel;
    private DreamUtil mDreamUtil = new DreamUtil();

    public GifPhotoUI(int cameraId, PhotoController baseController, CameraActivity activity,
            View parent) {
    ...
    public void fitTopPanel(ViewGroup topPanelParent) {
        ...
        if (DreamUtil.BACK_CAMERA == mDreamUtil.getRightCamera(DataModuleManager
            ...
            topPanel = lf.inflate(R.layout.gifphoto_top_panel, topPanelParent);
        } else {
            topPanel = lf.inflate(R.layout.gifphoto_front_top_panel,
                    topPanelParent);
        }
    ...
    public void updateGifFlashTopPanel(ButtonManagerDream buttonManager,
        ...
        if (DreamUtil.BACK_CAMERA == mDreamUtil
                ...
                && DataModuleManager
                        ...
                        .isEnableSettingConfig(
                                Keys.KEY_DREAM_FLASH_GIF_PHOTO_MODE)) {
            if (buttonManager != null && !mBasicModule.mIsBatteryLow) {
                buttonManager.updateGifFlashButton(ButtonManagerDream.BUTTON_GIF_PHOTO_FLASH_DREAM, disable);
            }
        }
    }
}
