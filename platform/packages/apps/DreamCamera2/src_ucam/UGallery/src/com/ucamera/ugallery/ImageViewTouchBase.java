...
//        }
    ...
    public void setImageRotation(int rotation) {
        int currentRotation = (mBitmapDisplayed.getRotation() + rotation + 360) % 360;
        mBitmapDisplayed.setRotation(currentRotation);
        requestLayout();
    }
    ...
    public void setImageRotateBitmapResetBase(final RotateBitmap bitmap, final boolean resetSupp) {
        ...
        if (bitmap.getBitmap() != null && !bitmap.getBitmap().isRecycled()) {
