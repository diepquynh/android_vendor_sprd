...
public class EFACMain extends EF {
    ...
    {
        Log.d(TAG, "decodeDER buffer > " + ByteArrayConverter.byteArrayToHexString(buffer));
        ...
        Log.d(TAG,"decodeDER refreshTag = " + ByteArrayConverter.byteArrayToHexString(refreshTag));
        Log.d(TAG,"decodeDER getrefreshTag = " + ByteArrayConverter.byteArrayToHexString(this.mSEHandle.getRefreshTag()));
