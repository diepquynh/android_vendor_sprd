...
public class InstallShortcutReceiver extends BroadcastReceiver {
    ...
    public static final String SHORTCUT_MIMETYPE =
            "com.android.sprdlauncher2/shortcut";
    ...
    public void onReceive(Context context, Intent data) {
        ...
        /* SPRD : fix bug282468 , fix bug281022 ,coverity 82689, fix bug 261948, add toast for shortcut installed @{ */
        if (SprdUtilities.shortcutExist(context, intent.getComponent(), name)) return;
        if(name != null)
            Toast.makeText(context, context.getString(R.string.shortcut_installed,
                    name), Toast.LENGTH_SHORT).show();
        /* @} */
        /* SPRD: Fix bug 327879,judge implemention before cast an object. @{ */
        Bitmap icon = null;
        Intent.ShortcutIconResource iconResource = null;
        Object obIcon = data.getParcelableExtra(Intent.EXTRA_SHORTCUT_ICON);
        Object obIconRes = data.getParcelableExtra(Intent.EXTRA_SHORTCUT_ICON_RESOURCE);
        if (obIcon instanceof Bitmap) {
            icon = (Bitmap)obIcon;
        }
        if (obIconRes instanceof Intent.ShortcutIconResource) {
            iconResource = (Intent.ShortcutIconResource)obIconRes;
        }
        /* @} */
