...
$(LOCAL_BUILT_MODULE): CODEC_PARAM_FILE := /data/local/media/codec.bin
...
$(LOCAL_BUILT_MODULE): CODEC_SYMLINK := $(TARGET_OUT_VENDOR)/firmware/codec
ifeq ($(strip $(BOARD_USES_REALTEK_CODEC)),true)
$(LOCAL_BUILT_MODULE): REALTEK_CODEC_EXTEND_PARAM_FILE := /data/local/media/realtek_codec.bin
...
$(LOCAL_BUILT_MODULE):
	...
	$(hide) echo "Symlink: $(CODEC_SYMLINK) -> $(CODEC_PARAM_FILE)"
ifeq ($(strip $(BOARD_USES_REALTEK_CODEC)),true)
...
ifeq ($(strip $(BOARD_USES_REALTEK_CODEC)),true)
	...
	$(hide) ln -sf $(CODEC_PARAM_FILE) $(CODEC_SYMLINK)
ifeq ($(strip $(BOARD_USES_REALTEK_CODEC)),true)
