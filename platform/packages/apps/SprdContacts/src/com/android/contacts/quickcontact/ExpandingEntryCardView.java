...
public class ExpandingEntryCardView extends CardView {
    ...
    private View createEntryView(LayoutInflater layoutInflater, final Entry entry,
            int iconVisibility) {
        /**
         * AndroidN porting----add a new layout for entry card item view of two panel view.
         ...
         */
        EntryView view = null;
        boolean mIsTwoPanel = getResources().getBoolean(R.bool.quickcontact_two_panel);
        if(mIsTwoPanel) {
            view = (EntryView) layoutInflater.inflate(
                    R.layout.expanding_entry_card_item_compat_sprd, this, false);
        } else {
            view = (EntryView) layoutInflater.inflate(
                    R.layout.expanding_entry_card_item, this, false);
        }
    ...
    public List<List<Entry>> getEntrys() {
