...
public class IconCache {
    ...
    String[] mSysIcons;
    /* @} */
    // SPRD: Fix bug 298926, for mobile operator icons.
    String[] mMobileOperatorIcons;
    ...
    public IconCache(Context context) {
        ...
        mSysIcons = mContext.getResources().getStringArray(R.array.sysicons);
        // SPRD: Fix bug 298926, for mobile operator icons.
        mMobileOperatorIcons = mContext.getResources().getStringArray(R.array.mobile_operator_icons);
    }
