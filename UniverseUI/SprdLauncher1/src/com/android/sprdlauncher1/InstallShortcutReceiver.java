...
public class InstallShortcutReceiver extends BroadcastReceiver {
    ...
    public static final String SHORTCUT_MIMETYPE =
            "com.android.sprdlauncher1/shortcut";
            ...
            try {
                ...
                if (info.icon != null) {
                    ...
                    if (iconByteArray != null) {
                        ...
                        Log.e(TAG,"addToInstallQueue() the iconByteArray is null");
                    }
                    /* @} */
                }
            ...
            if (strings != null) {
                ...
                while (newStringsIter.hasNext()) {
                    ...
                    try {
                        ...
                        /* SPRD: bug304952 2014-04-25 null exception handling. @{ */
                        if (pn == null && launchIntent.getComponent() != null) {
                            pn = launchIntent.getComponent().getPackageName();
                        }
                        if (pn != null && packageNames.contains(pn)) {
    ...
    public void onReceive(Context context, Intent data) {
        ...
        /* SPRD: fix bug 259254, add toast for shortcut installed @{ */
        if(name != null){
