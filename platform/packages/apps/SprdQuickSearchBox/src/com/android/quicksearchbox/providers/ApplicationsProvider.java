...
public class ApplicationsProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projectionIn, String selection,
        ...
        Log.d("gaolj", "App  query(" + uri + ",null," + selection + ","
                + Arrays.toString(selectionArgs) + ",null)");
    ...
    private Cursor searchApplications(String query, String[] projectionIn,
        ...
        if (!zeroQuery) {
            /**
             * SPRD: Modify 20140606 Spreadst of bug320517, search applications
             * irrelevant results are shown @{
             */
      ...
      Log.d("liuyj", "Returning " + cursor.getCount()+ " results for " + query);
        return cursor;
    }
