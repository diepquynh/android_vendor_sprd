...
public class LauncherAppState {
    ...
    private static final String SHARED_PREFERENCES_KEY = "com.android.sprdlauncher1.prefs";
    ...
    private UnreadLoader mUnreadLoader; // SPRD: Feature 255689, porting from Android.4.1
    ...
    private LauncherAppState() {
        ...
        // SPRD: Feature 255689, porting from Android.4.1 start @{
        ...
        // SPRD: Feature 255689, porting from Android.4.1 end @}
    ...
    public void onTerminate() {
        ...
        sContext.unregisterReceiver(mUnreadLoader); // SPRD: Feature 255689, porting from Android.4.1
    ...
    LauncherModel setLauncher(Launcher launcher) {
        ...
        mUnreadLoader.initialize(launcher); // SPRD: Feature 255689, porting from Android.4.1
        return mModel;
    }
