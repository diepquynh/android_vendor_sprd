...
import com.android.camera.qr.CameraManager;
import com.android.camera.qr.PlanarYUVLuminanceSource;

final class QrDecodeHandler extends Handler {

    private static final String TAG = QrDecodeHandler.class.getSimpleName();

    private final QrScanActivityCapture activity;
    private final MultiFormatReader multiFormatReader;

    QrDecodeHandler(QrScanActivityCapture activity, Hashtable<DecodeHintType, Object> hints) {
