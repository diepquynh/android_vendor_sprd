...
public class BookmarkUtils {
     ...
     */
         ...
         *@{
         */
    static AlertDialog displayRemoveBookmarkDialog( final long id, final String title,
        ...
        AlertDialog sAlertdialog = new AlertDialog.Builder(context)
                            ...
                            Runnable runnable = new Runnable(){
                                ...
                                public void run() {
                                    ...
                                    try {
                                        ...
                                        Log.w(LOGTAG, "remove bookmark error " + e);
                                    }
                                }
                            };
