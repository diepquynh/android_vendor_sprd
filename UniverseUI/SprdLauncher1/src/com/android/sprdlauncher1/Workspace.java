...
import com.android.sprdlauncher1.FolderIcon.FolderRingAnimator;
import com.android.sprdlauncher1.Launcher.CustomContentCallbacks;
import com.android.sprdlauncher1.LauncherSettings.Favorites;
...
import com.sprd.launcher3.effect.EffectFactory;
import com.sprd.launcher3.effect.EffectInfo;
...
public class Workspace extends SmoothPagedView
    ...
    /* SPRD: Feature 247034,Define the MIN and MAX screen count of workspace. @{ */
    public static final int MIN_WORKSPACE_SCREEN_COUNT = 2;
    public static final int MAX_WORKSPACE_SCREEN_COUNT = 12;
    /* @} */

    /* SPRD: Feature 248819,Porting from SprdLauncher(Android4.1). @{ */
    ...
    /* SPRD: add for UUI previews @{*/
    private float mMultiTouchStart;
    private float mMultiTouchStop;
    /* @} */
    ...
    public void onDragStart(final DragSource source, Object info, int dragAction) {
        /* SPRD: add for UUI previews, fix bug321933 add log. @{ */
        if (mLauncher.isWorkspacePreviewsVisible()) {
            return;
        }
        Log.d(TAG, "Workspace onDragStart()");
        /* @} */
    ...
    public void onDragEnd() {
        /* SPRD: fix bug321933 add log. @{ */
        Log.d(TAG, "Workspace onDragEnd()");
        /* @} */
    ...
    public void onChildViewAdded(View parent, View child) {
        ...
        // @SPRD: 3D Box transfer
//        updateBitmapBuffer(false);
    }
...
//    /* @} */
    ...
    public long insertNewWorkspaceScreenBeforeEmptyScreen(long screenId) {
        ...
        /* SPRD: Feature 247034,We could have MAX_WORKSPACE_SCREEN_COUNT(12) screens at most. @{ */
        if (mWorkspaceScreens.size() == MAX_WORKSPACE_SCREEN_COUNT) {
            Log.i(TAG, "Workspace.insertNewWorkspaceScreenBeforeEmptyScreen(),reached MAX_WORKSPACE_SCREEN_COUNT:" + MAX_WORKSPACE_SCREEN_COUNT);
            return -1;
        }
        /* @} */
    ...
    public void addExtraEmptyScreenOnDrag() {
        ...
        /* SPRD: Feature 247034, If there is already an DefaultEmptyScreen,wo have no need to add an ExtraEmptyScreen,
         * And we could have MAX_WORKSPACE_SCREEN_COUNT(12) screens at most. @{ */
        if (getDefaultEmptyScreenNum() > 0) {
            Log.i(TAG, "Workspace.addExtraEmptyScreenOnDrag(),there is already an DefaultEmptyScreen,wo have no need to add an ExtraEmptyScreen!");
            return;
        }

        if (mWorkspaceScreens.size() == MAX_WORKSPACE_SCREEN_COUNT) {
            Log.i(TAG, "Workspace.addExtraEmptyScreenOnDrag(),reached MAX_WORKSPACE_SCREEN_COUNT:" + MAX_WORKSPACE_SCREEN_COUNT);
            return;
        }
        /* @} */
    ...
    public boolean addExtraEmptyScreen() {
        /* SPRD: Feature 247034,We could have MAX_WORKSPACE_SCREEN_COUNT(12) screens at most. @{ */
        if (mWorkspaceScreens.size() == MAX_WORKSPACE_SCREEN_COUNT) {
            Log.i(TAG, "Workspace.addExtraEmptyScreen(),reached MAX_WORKSPACE_SCREEN_COUNT:" + MAX_WORKSPACE_SCREEN_COUNT);
            return false;
        }
        /* @} */
        if (!mWorkspaceScreens.containsKey(EXTRA_EMPTY_SCREEN_ID)) {
    ...
    public void stripEmptyScreens() {
        /* SPRD: add for UUI : we maintain empty screens @{ */
        if (true) {
            return;
        }
        /* @} */
        ...
        /* SPRD: Feature 247034,We should have MIN_WORKSPACE_SCREEN_COUNT(2) screens at least @{ */
        // We enforce at least one page to add new items to. In the case that we remove the last
        // such screen, we convert the last screen to the empty screen
        //int minScreens = MIN_WORKSPACE_SCREEN_COUNT + numCustomPages();
        int minScreens = MIN_WORKSPACE_SCREEN_COUNT + numCustomPages();
        /* @} */
        int pageShift = 0;
        for (Long id: removeScreens) {
            ...
            */
            if (getReallyScreenCount() > minScreens) {
...
//        /* @SPRD: 3D Box transfer @{*/
//        if (mLauncher.is3DMode()) {
////            Log.w(TAG, "-----onInterceptTouchEvent-----");
//            if (mLauncher.mSprdSurfaceView != null) {
//                mLauncher.mSprdSurfaceView.onTouchEvent(ev);
//            }
//            return false;
//        }
//        /* @} */
        ...
        case MotionEvent.ACTION_UP:
            if (mTouchState == TOUCH_STATE_REST) {
                ...
                /* SPRD: Bug 266828,add the judgment  @{ */
                if(currentPage != null) {
                /* @} */
    ...
    protected void onPageBeginMoving() {
        /* @SPRD: 3D Box transfer @{*/
//        Log.w(TAG, "-----onPageBeginMoving-----");
//        if (!mResponseBackKey) {
//            if (isSupport3DEffect() && shouldShow3DEffect() && mLauncher.is3DEffectSelected()
//                    && !mLauncher.is3DMode() && mLauncher.show3DEffectView(true)) {
//                if (mIsPageMoving) {
//                    mIsPageMoving = false;
//                }
...
//        /* @} */
    ...
    public void showOutlinesTemporarily() {
        if (!mIsPageMoving && !isTouchActive()) {
            // @SPRD: Don't show 3D Box transfer
//            mResponseBackKey = true;
    ...
    */
    ...
    public boolean enterOverviewMode() {
        ...
        /* SPRD: Fix bug 271058,reset the state of all Screens before enter OverviewMode. @{ */
        if (!mScroller.isFinished()) {
            mScroller.forceFinished(true);
            resetScreenScrolledPage();
        }
        /* @} */
        // SPRD: fix bug263283
    ...
    Animator getChangeStateAnimation(final State state, boolean animated, int delay, int snapPage) {
        ...
        /* SPRD: Feature 252093,Hotseat should be visiable in AllAppsView. @{ */
        float finalHotseatAndPageIndicatorAlpha = (stateIsOverview) ? 0f : 1f;
        /* @} */
        ...
        /* SPRD: Feature 252093,backHomeButton should change to allAppsButton while workspace in NORMAL state. @{ */
        if (stateIsNormal) {
            mLauncher.getHotseat().backHomeButton.setVisibility(View.GONE);
            mLauncher.getHotseat().allAppsButton.setVisibility(View.VISIBLE);
        }
        /* @} */
    ...
    public boolean acceptDrop(DragObject d) {
        ...
        /* SPRD : Feature 259755,Do not support any Drag in MTBF mode. @{ */
        if (mLauncher.isMTBFMode()) {
            return false;
        }
        /* @} */
    ...
    boolean willCreateUserFolder(ItemInfo info, CellLayout target, int[] targetCell, float
        ...
        if (distance > mMaxDistanceForFolderCreation) {
            ...
            if (mLauncher.isHotseatLayout(mDragTargetLayout)) {
                Log.d(TAG, "distance = " +distance +" mMaxDistanceForFolderCreation = " +mMaxDistanceForFolderCreation);
            }
            /* @} */
            return false;
        }
        ...
        if (dropOverView != null) {
            CellLayout.LayoutParams lp = (CellLayout.LayoutParams) dropOverView.getLayoutParams();
                if (lp.useTmpCoords && (lp.tmpCellX != lp.cellX || lp.tmpCellY != lp.tmpCellY)) {
                    /* SPRD: fix bug321933 add log. @{ */
                    if (mLauncher.isHotseatLayout(mDragTargetLayout)) {
                        Log.d(TAG, "lp.useTmpCoords = " + lp.useTmpCoords + " , lp.tmpCellX = " + lp.tmpCellX
                                +" , lp.cellX = " + lp.cellX + " ,  lp.tmpCellY = " + lp.tmpCellY +" , lp.cellY = " + lp.cellY);
                    }
                    /* @} */
                    return false;
                }
        ...
        if (dropOverView == null || hasntMoved || (considerTimeout && !mCreateUserFolderOnDrop)) {
            /* SPRD: fix bug321933 add log. @{ */
            if (mLauncher.isHotseatLayout(mDragTargetLayout)) {
                Log.d(TAG, "dropOverView = " + dropOverView +" , hasntMoved = " + hasntMoved
                        + " , considerTimeout = " + considerTimeout +" , mCreateUserFolderOnDrop = " + mCreateUserFolderOnDrop);
            }
            /* @} */
            return false;
        }
    ...
    boolean createUserFolderIfNecessary(View newView, long container, CellLayout target,
        ...
        boolean hasntMoved = false;
        /* SPRD: coverity 70815 @{*/
        long draginfoScreenId = 0;
        if (mDragInfo != null) {
            CellLayout cellParent = getParentCellLayoutForView(mDragInfo.cell);
            hasntMoved = (mDragInfo.cellX == targetCell[0] &&
                    mDragInfo.cellY == targetCell[1]) && (cellParent == target);
            draginfoScreenId = mDragInfo.screenId;
        }else{
            Log.e(TAG, "createUserFolderIfNecessary the mDragInfo is null.");
            // SPRD: fix bug 298536
            if (!external)
                return false;
        }
        ...
        final long screenId = (targetCell == null) ? draginfoScreenId : getIdForScreen(target);
        /* @} */
    ...
    /* SPRD: fix bug256574 @{ */
    private boolean isWidget(ItemInfo dragInfo) {
   ...
   static private float squaredDistance(float[] point1, float[] point2) {
    ...
    public void onDragOver(DragObject d) {
        ...
        if (mDragTargetLayout != null) {
            ...
            /* SPRD: coverity 83482, fix bug321933 add log. @{ */
            if (dragOverView != null) {
                manageFolderFeedback(info, mDragTargetLayout, mTargetCell,
                        targetCellDistance, dragOverView);
            } else {
                if (isHotseatLayout) {
                    Log.w(TAG,"onDragOver(DragObject d) the dragOverView is null");
                }
            }
            /* @} */
    ...
    private void manageFolderFeedback(ItemInfo info, CellLayout targetLayout,
        ...
        /* SPRD: fix bug321933 add log. @{ */
        if (mLauncher.isHotseatLayout(mDragTargetLayout)) {
            Log.d(TAG, "mDragMode = " + mDragMode +" , userFolderPending = " + userFolderPending
                    +" , mFolderCreationAlarm.alarmPending() = " + mFolderCreationAlarm.alarmPending());
        }
        /* @} */
        ...
        if (info instanceof PendingAddItemInfo) {
            ...
            Runnable onAnimationCompleteRunnable = new Runnable() {
                ...
                public void run() {
                    ...
                    /* SPRD: Feature 254784,Add custome widget into workspace. @{ */
                    case LauncherSettings.Favorites.ITEM_TYPE_WIDGET_OWNER:
                        mLauncher.addCustomWidget(pendingInfo, container,
                                screenId, mTargetCell, null);
                        break;
                    /* @} */
    ...
    public void onDropCompleted(final View target, final DragObject d,
        ...
        if ((d.cancelled || (beingCalledAfterUninstall && !mUninstallSuccessful))
                && (mDragInfo != null && mDragInfo.cell != null)) { //SPRD: coverity 70817
            mDragInfo.cell.setVisibility(VISIBLE);
        }else{
            Log.w(TAG, "the cell is not visible!");
        }

        mDragOutline = null;

        /* SPRD: bug310651 2014-06-05 OOM problem optimize. @{ */
        // this will release every DragView hold by CellLayout.
        ...
        mDragInfo = null;
        /* SPRD: Feature 248618,we should exit SpringLoaded mode after drag completed. @{ */
        mLauncher.exitSpringLoadedDragModeDelayed(success, false, null);
        /* @} */
    }
    ...
    public void restoreInstanceStateForChild(int child) {
        if (mSavedStates != null) {
            ...
            /* SPRD: Fix bug 291984,NullPointerException. @{ */
            if (cl != null) {
                cl.restoreInstanceState(mSavedStates);
            } else {
                Log.w(TAG, "restoreInstanceStateForChild: cl is null!");
            }
            /* @} */
        }
    }
    ...
    private void moveToScreen(int page, boolean animate) {
        if (!isSmall()) {
            if (animate) {
                // @SPRD: add for bug 265871, don't show 3D Box transfer
//                mResponseBackKey = true;
                snapToPage(page);
            } else {
                setCurrentPage(page);
    ...
    /**
     * SPRD: Feature 247034,Get default empty screen count. @{
     *
     * @return int
     */
    public int getDefaultEmptyScreenNum() {
        int defaultEmptyScreenCount = 0;
        for (Long id : mWorkspaceScreens.keySet()) {
            if (id > 0 && mWorkspaceScreens.get(id).getShortcutsAndWidgets().getChildCount() == 0) {
                defaultEmptyScreenCount++;
            }
        }
        return defaultEmptyScreenCount;
    }
    /** @} */

    /**
     * SPRD: Feature 247034,Get screen count except the EmptyScreen with EXTRA_EMPTY_SCREEN_ID. @{
     *
     * @return int
     */
    public int getReallyScreenCount() {
        int count = 0;
        for (Long id : mWorkspaceScreens.keySet()) {
            if (id > 0) {
                count++;
    ...
    /**
     * SPRD: Feature 248819,unregisterPreferenceListenerForWorkspaceStyle(). @{
     *
     */
    private void unregisterPreferenceListenerForWorkspaceStyle(){
        // unregitster when detach
        SharedPreferences mAnimPreferences = mLauncher.getSharedPreferences(WorkspaceSettings.WORKSPACE_STYLE, Context.MODE_PRIVATE);
        mAnimPreferences.unregisterOnSharedPreferenceChangeListener(mAnimationStyleChangeListener);
    }
    /** @} */

    /**
     * SPRD: Feature 248819,registerPreferenceListenerForWorkspaceStyle(). @{
     *
     */
    ...
    /* SPRD: Feature 248819,New a Workspace setting PreferenceListener. @{ */
    private OnSharedPreferenceChangeListener mAnimationStyleChangeListener = new OnSharedPreferenceChangeListener(){
        public void onSharedPreferenceChanged( SharedPreferences sharedPreferences, String key) {
            if(WorkspaceSettings.KEY_ANIMATION_STYLE.equalsIgnoreCase(key)){
                initAnimationStyle();
    ...
    /**
     * SPRD: Feature 248819,Init slide Animation. @{
     *
     */
    private void initAnimationStyle(){
        SharedPreferences mAnimPreferences = mLauncher.getSharedPreferences(WorkspaceSettings.WORKSPACE_STYLE, Context.MODE_PRIVATE);
        int type = mAnimPreferences.getInt(WorkspaceSettings.KEY_ANIMATION_STYLE, ANIMATION_DEFAULT);
        mCurentAnimInfo = EffectFactory.getEffect(type);
        // SPRD: add 3DEffect
//        mLauncher.onEffectChanged(type);
    }
    /** @} */
    ...
    private void screenScrolledStandardUI(int screenCenter) {
        ...
        /* SPRD: Bug 255008,page rotate wrong after slide animation. @{ */
        ...
        /* @} */
                ...
                if (android.os.Build.VERSION.SDK_INT > 15 && offset != 0 && offset != 1 && offset != -1) {
                    if (isOverscrollingFirstPage && mOverScrollX < 0) {
                        mCurentAnimInfo.getTransformationMatrix(v, offset,pageWidth,pageHeight,true,true);
                    } else if (isOverscrollingLastPage && mOverScrollX > mMaxScrollX) {
                        mCurentAnimInfo.getTransformationMatrix(v, offset,pageWidth,pageHeight,true,false);
                    } else {
                        mCurentAnimInfo.getTransformationMatrix(v, offset,pageWidth,pageHeight,false, false);
                    }
                } else {
                    /* SPRD: fix bug331782 reset view position properly. @{ */
    ...
    /* SPRD: Fix bug 271058, reset the state of all Screens. @{ */
    private void resetScreenScrolledPage() {
        for (int i = 0; i < getChildCount(); i++) {
            View v = getPageAt(i);
            if (v != null) {
                int pageWidth = getScaledMeasuredWidth(v);
    ...
    public void updateDefaultScreenNum(int defaultScreenNum) {
        if (mCustomizePreference == null) {
            mCustomizePreference = (SharedPreferences) mLauncher
                    .getSharedPreferences(Launcher.CUSTOMIZEPREF,
                            Context.MODE_PRIVATE);
        }
        Editor editor = mCustomizePreference.edit();
        editor.putInt(Launcher.HOME_DEFAULT_SCREEN_TAG, defaultScreenNum);
        editor.commit();
    ...
    void setScreen(int currentScreen) {
        ...
        /* @} */
        /* SPRD: Bug 283667 @{ */
        snapToPageImmediately(this.getCurrentScreen());
        /* @} */
    }
    ...
    private void multiTouch() {
        ...
        if (isInOverviewMode())
            return;
        /* @} */
        if ((mMultiTouchStart - mMultiTouchStop) > 35.0f && !mLauncher.isWorkspacePreviewsVisible()) {
    ...
    private void initDefaultPage(){
        ...
        mDefaultPage = mCustomizePreference.getInt(Launcher.HOME_DEFAULT_SCREEN_TAG, mDefaultPage);
    }
    /* @} */

    /* @SPRD: 3D transfer @{*/
//    private boolean mResponseBackKey = false;
//
//    private void updateBitmapBuffer(boolean remove) {
////        Log.w(TAG, "updateBitmapBuffer: " + remove, new Throwable());
//        if (null == mBitmapsBuffer) {
////          loadBitmapsBuffer();
//            return;
//        }
...
//                final int delta = curPage - mBufferCurPage;
//                Log.w(TAG, "updateBitmapBuffer: " + curPage + ", " + mBufferCurPage);
//                if (delta > 1 || delta < -1) {
//                    loadBitmapsBuffer(mLauncher.isSupportScroll());
//                    return;
//                }
//                if (0 == delta) {
//                    if (null != mBitmapsBuffer && null != mBitmapsBuffer[1]) {
//                        mBitmapsBuffer[1].recycle();
//                        mBitmapsBuffer[1] = null;
//                        Log.w(TAG, "updateBitmapBuffer recycle - 1, " + curPage);
//                    }
//                    loadBitmapBuffer(1, curPage);
//                } else {
//                    if (null != mBitmapsBuffer[1 - delta]) {
//                        mBitmapsBuffer[1 - delta].recycle();
//                        mBitmapsBuffer[1 - delta] = null;
//                        Log.w(TAG, "updateBitmapBuffer - recycle " + (1-delta));
//                    }
//                    mBitmapsBuffer[1 - delta] = mBitmapsBuffer[1];
//                    loadBitmapBuffer(1, curPage);
//                    if (null != mBitmapsBuffer[1 + delta]) {
//                        mBitmapsBuffer[1 + delta].recycle();
//                        mBitmapsBuffer[1 + delta] = null;
//                        Log.w(TAG, "updateBitmapBuffer - recycle " + (1+delta));
//                    }
//                    if (mLauncher.isSupportScroll() || (curPage + delta > 0 && curPage + delta < getChildCount())) {
//                        loadBitmapBuffer(1 + delta, curPage + delta);
//                    }
//                }
//            }
//        });
//    }
    ...
    /**
     * SPRD: Feature 255689,updateComponentUnreadChanged(), modify from Android.4.1 @{
     *
     */
    public void updateComponentUnreadChanged(ComponentName component, int unreadNum) {
        SharedPreferences mUnreadInfoPreference = (SharedPreferences) mContext
                .getSharedPreferences(Launcher.UNREADINFO, Context.MODE_PRIVATE);
    ...
    public void addMTBFApps(ArrayList<AppInfo> list) {
        int pageIndex = 0;
        ...
        int maxCountPerScreen = cellCountX * cellCountY;
        int[] xy = new int[2];
        for (int i = 0; i < list.size(); i++) {
            pageIndex = i / maxCountPerScreen;
            xy[0] = i % cellCountX;
            xy[1] = (i / cellCountX) % cellCountY;
            if (pageIndex == getChildCount()) {
                addExtraEmptyScreen();
                commitExtraEmptyScreen();
            }
            Log.i(TAG, "screen=" + pageIndex + " x=" + xy[0] + " y=" + xy[1]);
            ShortcutInfo info = new ShortcutInfo(list.get(i));
            View shortcut = mLauncher.createShortcut(info);
            addInScreen(shortcut, LauncherSettings.Favorites.CONTAINER_DESKTOP,
                    getScreenIdForPageIndex(pageIndex), xy[0], xy[1], 1, 1, false);
        }
        requestLayout();
    }
    /* @} */
...
//    /* SPRD: add for bug 259489 @{ */
//    @Override
//    protected boolean isSupport3DEffect() {
//        return true;
//    }
//    /* @} */
//
//    /* SPRD: add for bug 265582 @{ */
//    @Override
//    protected boolean shouldShow3DEffect() {
