package plugin.sprd.protectedapp.util;
...
public class ApplicationsState {
    ...
    void doResumeIfNeededLocked() {
        ...
        if (!mBackgroundHandler.hasMessages(BackgroundHandler.MSG_LOAD_ENTRIES)) {
            ...
            editor.putString("load_entries_complete", "false");
            editor.commit();
            ...
            switch (msg.what) {
                ...
                case MSG_LOAD_ENTRIES: {
                    ...
                    if (numDone >= 6) {
                        ...
                        SharedPreferences preferences = mContext.getSharedPreferences("ProtectedApp", mContext.MODE_PRIVATE);
                        SharedPreferences.Editor editor = preferences.edit();
                        editor.putString("load_entries_complete", "true");
                        editor.commit();
    ...
    private class PackageIntentReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (Intent.ACTION_PACKAGE_ADDED.equals(actionStr)) {
                ...
                mSecurityClearDatabaseUtil.insert(pkgName);
                ...
                mSecurityClearDatabaseUtil.delete(pkgName);
    ...
    public static final AppFilter FILTER_NONE_SYSTEM = new AppFilter() {
        public void init() {
        }

        @Override
        public boolean filterApp(AppEntry entry) {
            return entry.info.enabled && (entry.info.flags & ApplicationInfo.FLAG_SYSTEM) == 0;
        }
    };
