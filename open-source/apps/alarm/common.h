...
#define LOGE(x...)   log_write(3, "<3>alarm: " x)
#define LOGW(x...)  log_write(5, "<5>alarm: " x)
#define LOGI(x...)    log_write(6, "<6>alarm: " x)
#define LOGD(x...)    log_write(6, "<6>alarm: " x)
#define LOGV(x...)    log_write(6, "<6>alarm: " x)
