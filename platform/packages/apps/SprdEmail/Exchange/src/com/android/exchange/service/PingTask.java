...
public class PingTask extends AsyncTask<Void, Void, Void> {
    ...
    protected Void doInBackground(Void... params) {
        ...
        try {
            ...
            /* SPRD: 435035, Prevent oom problem. { */
        } catch (java.lang.OutOfMemoryError e) {
            // TODO: This is hacky, try to be cleaner.
            // If we get any sort of exception here, treat it like the ping returned a connection
            // failure.
            // OOM occur because network response data is invalid,with no HTTP/1.1
            // when parseHead(),Not jump out of the loop
            LogUtils.e(TAG, e, "Ping OutOfMemoryError for account %d", mOperation.getAccountId());
            pingStatus = EasOperation.RESULT_NETWORK_PROBLEM;
        }
        /* } */
