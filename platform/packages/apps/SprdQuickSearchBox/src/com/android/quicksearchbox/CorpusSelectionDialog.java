...
public class CorpusSelectionDialog extends Dialog {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (event.getAction() == MotionEvent.ACTION_DOWN) {
            ...
            /*Modify 20121210 Spreadst of 97629 have IllegalArgumentException start */
           // cancel();
            /*add 20121226 Spreadst of 108854 quicksearchbox IllegalArgumentException start */
            try {
                if(this.isShowing()){
                    Log.d(TAG, "onTouchEvent  cancelDialog");
                    cancel();
                }
                return true;
            } catch (Exception e) {
            ...
            /*add 20121226 Spreadst of 108854 quicksearchbox IllegalArgumentException end */
            /*Modify 20121210 Spreadst of 97632 have IllegalArgumentException end */
        }
        return false;
    }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        /*Add 20121228 Spreadst of 103032 View not attached to window manager start */
        try {
            if (keyCode == KeyEvent.KEYCODE_DPAD_UP) {
            /*Modify 20121226 Spreadst of 98453 quicksearchbox have IllegalArgumentException start */
                if (mEditItems.isFocused() && isShowing()) {
                    Log.d(TAG, "onKeyDown 1 cancelDialog");
                    cancel();
                    return true;
                }
            /*Modify 20121226 Spreadst of 98453 quicksearchbox have IllegalArgumentException end */
            }
            // Dismiss dialog when typing on hard keyboard (soft keyboard is behind the dialog,
            // so that can't be typed on)
            if (event.isPrintingKey() && isShowing()) {
                Log.d(TAG, "onKeyDown 2 cancelDialog");
                cancel();
                return true;
            }
        } catch (Exception e) {
      ...
      /*Add 20121228 Spreadst of 103032 View not attached to window manager end */
        return false;
    }
    ...
    public void onBackPressed() {
        ...
        /*Modify 20130106 Spreadst of 108866 crash quicksearchbox IllegalArgumentException start*/
        try{
            Log.d(TAG, "onBackPressed  cancelDialog");
            cancel();
        }catch(IllegalArgumentException e){
            Log.e(TAG,"IllegalArgumentException ");
        }
        /*Modify 20130106 Spreadst of 108866 crash quicksearchbox IllegalArgumentException end*/
    }
    ...
    protected void selectCorpus(Corpus corpus) {
        /*Modify 20130106 Spreadst of 108866 crash quicksearchbox IllegalArgumentException start*/
        try{
            Log.d(TAG, "selectCorpus  dismiss");
          dismiss();
        }catch(IllegalArgumentException e){
            Log.e(TAG,"IllegalArgumentException ");
        }
