		...
		mali_bool in_upper_half)
{
	...
	if (in_upper_half) {
		...
		MALI_DEBUG_PRINT(4, ("Executor: Mali page fault detected at 0x%x from bus id %d of type %s on %s\n",
