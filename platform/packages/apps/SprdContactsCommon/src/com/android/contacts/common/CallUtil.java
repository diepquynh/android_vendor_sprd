...
public class CallUtil {
    ...
    public static int getVideoCallingAvailability(Context context) {
        ...
        if (telecommMgr == null || !um.isSystemUser()) {
            Log.i("CallUtil", "isVideoEnabled isSystemUser=" + um.isSystemUser());
            return VIDEO_CALLING_DISABLED;
        }/*@}*/

        /*add for VT for bug 600829  and bug606122@{*/
        if (!TelephonyManagerEx.isSupportVT() || !TelephonyManager.getDefault().isVideoCallingEnabled()) {
            return VIDEO_CALLING_DISABLED;
        }/*@}*/
    ...
    public static boolean isCallWithSubjectSupported(Context context) {
        ...
        for (PhoneAccountHandle accountHandle : accountHandles) {
            ...
            if (account != null && account.hasCapabilities(PhoneAccount.CAPABILITY_CALL_SUBJECT)) {
                return false; //SPRD: modify by bug594067 disable call with note function
            }
        }
        return false;
    }
