...
public class FloatingActionButtonController {
    ...
    private int mCurrentActionButton = -1;
    ...
    public void changeIcon(Drawable icon, String description ,int currentAction) {
        if (mFloatingActionButton.getDrawable() != icon
                || !mFloatingActionButton.getContentDescription().equals(description)
                || mCurrentActionButton != currentAction) {
    ...
    /**
     * SPRD: get currentAction for bug520005 @{
     * @return
     */
    public int getCurrentAction(){
        return mCurrentActionButton;
    }
    /** @} */
}
