...
import static com.android.messaging.smilplayer.dom.smil.SmilMediaElementImpl.SMIL_MEDIA_END_EVENT;
import static com.android.messaging.smilplayer.dom.smil.SmilMediaElementImpl.SMIL_MEDIA_PAUSE_EVENT;
import static com.android.messaging.smilplayer.dom.smil.SmilMediaElementImpl.SMIL_MEDIA_SEEK_EVENT;
import static com.android.messaging.smilplayer.dom.smil.SmilMediaElementImpl.SMIL_MEDIA_START_EVENT;
import static com.android.messaging.smilplayer.dom.smil.SmilParElementImpl.SMIL_SLIDE_END_EVENT;
import static com.android.messaging.smilplayer.dom.smil.SmilParElementImpl.SMIL_SLIDE_START_EVENT;
...
import com.android.messaging.smilplayer.dom.smil.parser.SmilXmlParser;
...
public class SmilHelper extends SmilHelperSprd{
    ...
    private static SMILDocument createSmilDocument(PduBody pb) {
        ...
        DrmManagerClient drmManagerClient = SmilPlayerApp.getDrmManagerClient();
        ...
        for (int i = 0; i < partsNum; i++) {
            ...
            if (contentType != null && (contentType.equals(ContentType.TEXT_PLAIN)
                ...
                hasMedia = true;
                /* SPRD: Add for bug#282502 
                 * orig: else if (ContentType.isAudioType(contentType)) @{ */
            } else if (ContentType.isAudioType(contentType) || containsTag(part, EXTENDS_TAG_OGG)) {
                /* @} */
                ...
                hasMedia = true;
            } else if (containsTag(part, EXTENDS_TAG_VCARD) || isVcard(part)) {
            ...
            } else if (containsTag(part, ELEMENT_TAG_VCALENDAR_FILE) || isVCalendar(part)) {/*@}*/
                SMILMediaElement vcalendarElement = createMediaElement(
                        ELEMENT_TAG_VCALENDAR, document, part.generateLocation());
                par.appendChild(vcalendarElement);
                hasMedia = true;
            } else {
    ...
    private static SMILDocument createSmilDocument(SlideshowModel slideshow) {
        ...
        List<SlideModel> slides = new ArrayList<SlideModel>(Arrays.asList(slideshow.toArray(new SlideModel[slideshow.size()])));
        Collections.copy(slides, slideshow);
        ...
        for (SlideModel slide : slides) {
            ...
            for (MediaModel media : slide) {
                ...
                if (media instanceof TextModel) {
                    ...
                    sme = SmilHelper.createMediaElement(SmilHelper.ELEMENT_TAG_VCALENDAR, document, src);
                } else {
