...
public class WcdmaShowRecord {

    private static final String TAG = "WcdmaShowRecord";
    ...
    public WcdmaShowRecord(Context context){
        mContext=context;
    ...
    public String getServerData(int simid){
        ...
        if (atResponse.contains(IATUtils.AT_OK)) {
            ...
            for (int i = 0; i < str2.length; i++) {
                ...
                if (i == 2) {
                    int temp = Integer.parseInt(str2[i].replace("+", "-").trim());
                    values[5] = values[5] + ": "
            ...
            for (int i = 0; i < 5; i++) {
                if (i < str2.length) {
                    if (str2[i].contains(",")) {
                        ...
                        for (int j = 0; j < 3; j++) {
                            if (j == 2) {
                                int temp = Integer.parseInt(str3[j].replace("+", "-").trim());
