...
public class BookmarksLoader extends CursorLoader {
    ...
    public Cursor loadInBackground() {
        ...
        try {
            ...
            Log.e("BookmarksLoader","loadInBackground :"+e);
            if (cursor != null) {
                cursor.close();
                cursor = null;
            }
    ...
    /**
     *SPRD:
     *  sprd feature 522253 of menu add bookmark
     *@{
     */
    public static final String EXTRA_ADD_BOOKMARK_IN_FOLDER_ID = "extra_add_bookmark_in_folder_id";
    public static final String EXTRA_ADD_BOOKMARK_IN_FOLDER_NAME = "extra_add_bookmark_in_folder_name";
    /**
     *@}
     */
}
