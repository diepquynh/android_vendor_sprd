 ...
 */
#define POWER_MANAGEMENT_CALLBACKS (&pm_sc9838_callbacks)
 ...
 */
#define PLATFORM_FUNCS (&platform_sc9838_funcs)
...
extern struct kbase_pm_callback_conf pm_sc9838_callbacks;
extern struct kbase_platform_funcs_conf platform_sc9838_funcs;
