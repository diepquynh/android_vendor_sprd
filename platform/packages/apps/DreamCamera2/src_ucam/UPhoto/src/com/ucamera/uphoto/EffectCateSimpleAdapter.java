...
public class EffectCateSimpleAdapter extends SimpleAdapter {
    private int[] mTo;
    ...
    public EffectCateSimpleAdapter(Context context, List<? extends Map<String, ?>> data,
...
//                    setTextAlpha(textView, position);
    ...
    private void setTextAlpha(TextView text, int position) {
        if (mSelected == position) {
            text.setTextColor(0xFFFFFFFF);
        }
        else {
            text.setTextColor(0x7FFFFFFF);
        }
    }
