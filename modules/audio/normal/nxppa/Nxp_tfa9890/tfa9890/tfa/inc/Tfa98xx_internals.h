...
Tfa98xx_Error_t Tfa98xx_DspSupportFramework(Tfa98xx_handle_t,
					    int *pbSupportFramework);
Tfa98xx_Error_t Tfa98xx_DspReadSpkrParams(Tfa98xx_handle_t handle,
					  unsigned char paramId, int length,
					  unsigned char *pSpeakerBytes);
Tfa98xx_Error_t Tfa98xx_DspSetParamVarWait(Tfa98xx_handle_t handle,
					   unsigned char module_id,
					   unsigned char param_id,
					   int num_bytes,
					   const unsigned char data[],
					   int waitRetryCount);
Tfa98xx_Error_t Tfa98xx_DspSetParamMultipleVarWait(int handle_cnt,
