...
struct gengetopt_args_info
{
  ...
  int fs_arg;	/**< @brief use specified samplerate in Herz (default='48000').  */
  char * fs_orig;	/**< @brief use specified samplerate in Herz original value given at command line.  */
  const char *fs_help; /**< @brief use specified samplerate in Herz help description.  */
  int i2s_arg;	/**< @brief select i2s input 1 or 2 (default='1').  */
  char * i2s_orig;	/**< @brief select i2s input 1 or 2 original value given at command line.  */
  const char *i2s_help; /**< @brief select i2s input 1 or 2 help description.  */
  char * pll_arg;	/**< @brief select pll clock input BCK or WS (default='BCK').  */
  char * pll_orig;	/**< @brief select pll clock input BCK or WS original value given at command line.  */
  const char *pll_help; /**< @brief select pll clock input BCK or WS help description.  */
  ...
  char * loadDrc_arg;	/**< @brief read drc settings from saved file.  */
  char * loadDrc_orig;	/**< @brief read drc settings from saved file original value given at command line.  */
  const char *loadDrc_help; /**< @brief read drc settings from saved file help description.  */
  char * loadPatch_arg;	/**< @brief rload patch from file.  */
  char * loadPatch_orig;	/**< @brief rload patch from file original value given at command line.  */
  const char *loadPatch_help; /**< @brief rload patch from file help description.  */
  ...
  unsigned int i2s_given ;	/**< @brief Whether i2s was given.  */
  unsigned int pll_given ;	/**< @brief Whether pll was given.  */
  ...
  unsigned int loadDrc_given ;	/**< @brief Whether loadDrc was given.  */
  unsigned int loadPatch_given ;	/**< @brief Whether loadPatch was given.  */
