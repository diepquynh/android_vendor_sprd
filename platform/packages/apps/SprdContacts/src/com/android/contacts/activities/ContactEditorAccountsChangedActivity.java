...
public class ContactEditorAccountsChangedActivity extends Activity {
    ...
    //add for SPRD:Bug 564152 Can't create contacts after system language changes
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        .show();
        /**
         * SPRD:Bug 564152 Can't create contacts after system language changes
         *
         * @{
         */
    ...
    // add for Bug564152 Can't create contacts after system language changes
