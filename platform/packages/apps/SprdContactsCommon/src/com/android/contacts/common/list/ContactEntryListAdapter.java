...
public abstract class ContactEntryListAdapter extends IndexerListAdapter {
     ...
     */
    /**
     * SPRD:549112 it's difficult to choose or cancel contacts
     * @{
     */
    protected IOnListCheckedChangeListener onListCheckedChangeListener;
    public interface IOnListCheckedChangeListener {
     ...
     * @{
     */
    public void setOnListCheckedChangeListener(
            IOnListCheckedChangeListener onListCheckedChangeListener) {
    ...
    protected void bindView(View itemView, int partition, Cursor cursor, int position) {
        ...
        if (isMultiPickerSupported()) {
            /**
             * SPRD:Bug 562706 Can't choose or cancel in search mode when batch delete
             * Original:final int pos = position;
             *
             * @{
             */
    ...
    public void changeDirectories(Cursor cursor) {
        ...
        invalidate();
        /**
         * SPRD:Bug 640716 it show differently when first search no result and second search
         */
...
//        }
        ...
        if (position == 0) {
            ...
            if (partition >= 0) {
                ...
                if (cursor != null) {
                    ...
                    // SPRD: Bug606200 The DUT occurs anr while importing attachment from message.
                    try {
                        cursor.moveToPosition(offset);
                    } catch (Exception e) {
                        Log.d(TAG, "move cursor position fails:" + e.toString());
                    }
                }
            }
        }
    ...
    */
        ...
        /* SPRD: Distinguish call log Badge and contact badge bug505148 @{ */
