...
#define BTA_MA_MAX_FILTER_TEXT_SIZE 256
...
typedef struct
{
    ...
    UINT8                 length_of_recipient; /* 0 if none*/
    char                  recipient[BTA_MA_MAX_FILTER_TEXT_SIZE];
    UINT8                 length_of_originator; /* 0 if none*/
    char                  originator[BTA_MA_MAX_FILTER_TEXT_SIZE];
