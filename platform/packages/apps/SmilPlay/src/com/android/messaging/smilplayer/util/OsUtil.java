...
public class OsUtil {
    ...
    public static boolean hasPhonePermission(final Context context) {
        return hasPermission(Manifest.permission.READ_PHONE_STATE, context);
    }

    public static boolean hasSmsPermission(final Context context) {
        return hasPermission(Manifest.permission.READ_SMS, context);
    }

    public static boolean hasLocationPermission(final Context context) {
        return OsUtil.hasPermission(Manifest.permission.ACCESS_FINE_LOCATION, context);
    }
    ...
    public static boolean hasStoragePermission(final Context context) {
        ...
        // together.
        return OsUtil.hasPermission(Manifest.permission.READ_EXTERNAL_STORAGE, context);
    }

    public static boolean hasRecordAudioPermission(final Context context) {
        return OsUtil.hasPermission(Manifest.permission.RECORD_AUDIO, context);
    }
    ...
    public static int SMS_PERMISSION_REQUEST_CODE = 1;
    public static void getSmsPreminssion(Activity activity) {
         activity.requestPermissions(
