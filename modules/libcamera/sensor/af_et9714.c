 ...
 *============================================================================*/
uint32_t et9714_init(uint32_t mode)
{
 ...
 *============================================================================*/
uint32_t et9714_write_dac_code(int32_t code)
{
	uint32_t ret_value = SENSOR_SUCCESS;
	uint8_t cmd_val[2] = { 0x00 };
 ...
 *============================================================================*/
uint32_t et9714_write_af(uint32_t param)
{
	uint32_t ret_value = SENSOR_SUCCESS;
	...
	while((m_cur_dac_code-target_code)>=MOVE_CODE_STEP_MAX){
		...
		et9714_write_dac_code(m_cur_dac_code);
 ...
 * 2: Linear Mode
 *============================================================================*/
uint32_t et9714_deinit(uint32_t mode)
{
	et9714_write_af(0);	
