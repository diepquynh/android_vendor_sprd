...
public class CropActivity extends Activity {
    ...
    private void checkPermissions() {
        ...
        if (getIntent().getBooleanExtra("from_photo_page", false)) {
            ...
            if (!mHasCriticalPermissions) {
                Intent intent = new Intent(CropActivity.this, CropPermissionsActivity.class);
                ...
                intent.putExtra(PermissionsActivity.UI_START_BY,
                        PermissionsActivity.START_FROM_CROP);
