...
public class FmRecorder implements MediaRecorder.OnErrorListener, MediaRecorder.OnInfoListener {
    ...
    /**
     * SPRD: bug474741, recording format selection. 0:amr; 1:3gpp
     * 
     * @{
     */
    ...
    public void startRecording(Context context) {
        ...
        /**
         * SPRD:Bug529776 Check the main card state Original Android code:
         * 
        ...
        if (recordingSdcard == null
                ...
                || (String.valueOf(context.getResources().getString(R.string.storage_sd)) == FmUtils.FM_RECORD_STORAGE_PATH_NAME && !Environment.MEDIA_MOUNTED
        ...
        if (GLOBAL_RECORD_FORMAT_FLAG == 1) {
            stringBuilder.append(".").append(time).append(RECORDING_FILE_EXTENSION).append(".tmp");
        } else {
        ...
        try {
            ...
            /**
             * SPRD: bug474741, recording format selection. Original Android code:
    ...
    public String getRecordFileName() {
        if (mRecordFile != null) {
            ...
            /**
             * SPRD: bug474741, recording format selection. Original Android code: int index =
             * fileName.indexOf(RECORDING_FILE_EXTENSION); if (index > 0) { fileName =
    ...
    public void saveRecording(Context context, String newName) {
        ...
        /**
         * SPRD: bug474741, recording format selection. Original Android code: File newRecordFile =
         * new File(mRecordFile.getParent(), newName + RECORDING_FILE_EXTENSION);
         * 
         * @{
         */
    ...
    public static int getPlaylistId(final Context context) {
        Cursor playlistCursor = context.getContentResolver().query(
                ...
                /**
                 * SPRD: bug498427, FM recording, repeat create playlists Original Android code:
                 * MediaStore.Audio.Playlists.DATA + "=?", new String[] {
