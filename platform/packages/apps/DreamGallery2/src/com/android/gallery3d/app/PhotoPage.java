...
public abstract class PhotoPage extends ActivityState implements
    ...
    private static final int MSG_FINISH_STATE = 17;
    ...
    private final GLView mRootPane = new GLView() {
        ...
        protected void onLayout(
            ...
            mPhotoView.layout(0, 20, right - left, bottom - top);
            if (mShowDetails) {
    ...
    /* SPRD: bug 635695, After edit, voice image cant play voice @{ */
    private void ifEditVoicePhoto(MediaItem current, Intent intent) {
        if (current instanceof LocalImage) {
            int voiceId = ((LocalImage) current).getVoiceId();
            if (voiceId != 0) {
                // To edit,and this photo has voice
                intent.putExtra(FilterShowActivity.VOICE_ID, voiceId);
            }
        }
    }
    /* @} */
    ...
    private void updateCurrentPhoto(MediaItem photo) {
        ...
        /* SPRD: bug 624616 ,Slide to DRM image, should Consume authority @{ */
        if (!mDrmFirstOpen && photo.getName() != null && photo.getName().endsWith(".dcf")
            ...
            SomePageUtils.getInstance().checkPressedIsDrm(mActivity,
                    photo, confirmListener, cancelListener, false);
        }
        /* @} */
...
//        }
        ...
        if (mCurrentPhoto.getMediaType() == MediaObject.MEDIA_TYPE_UNKNOWN) {
            return false;
        }
        /* @} */
        return true;
        ...
        switch (requestCode) {
            ...
            case REQUEST_SLIDESHOW_MUSIC:{
                if(resultCode == Activity.RESULT_OK && data != null && data.getData() != null){
                    mActivity.getAndroidContext();
                    GalleryUtils.setSlideMusicUri(mActivity.getAndroidContext(), data.getData().toString());
                    // SPRD: bug 566432, bug 569414 User defined cannot choose music
