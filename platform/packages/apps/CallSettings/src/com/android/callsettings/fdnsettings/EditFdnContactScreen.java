...
public class EditFdnContactScreen extends Activity {
    private static final String LOG_TAG = "EditFdnContactScreen";
    ...
    **/
    ...
    protected void onCreate(Bundle icicle) {
        ...
        **/
        mDataBusy = false;
        int phoneId = SubscriptionController.getInstance()
                .getPhoneId(mSubscriptionInfoHelper.getSubId());
